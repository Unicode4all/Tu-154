...
defineProperty("reverse_mid", globalPropertyf("sim/custom/anim/reverse_mid"))
...
-- gear
defineProperty("front_pos", globalPropertyf("sim/custom/anim/lg/front_pos")) -- положение передней стойки шасси
defineProperty("front_defl", globalPropertyf("sim/custom/anim/lg/front_defl")) -- просадка аммортизатора передней стойки
defineProperty("front_turn", globalPropertyf("sim/custom/anim/lg/front_turn")) -- поворот передней стойки шасси

defineProperty("main_pos_left", globalPropertyf("sim/custom/anim/lg/main_pos_left")) -- положение левой основной стойки. 0-1 - выпуск, -1 -5 - просадка аммортизатора
defineProperty("main_rot_left", globalPropertyf("sim/custom/anim/lg/main_rot_left")) -- поворот левой тележки на земле. 0 - горизонтально, -11 - в полете

defineProperty("main_pos_right", globalPropertyf("sim/custom/anim/lg/main_pos_right")) -- положение правой основной стойки. 0-1 - выпуск, -1 -5 - просадка аммортизатора
defineProperty("main_rot_right", globalPropertyf("sim/custom/anim/lg/main_rot_right")) -- поворот правой тележки на земле

-- tail
defineProperty("rudder_anim", globalPropertyf("sim/custom/anim/rudder_anim")) -- угол поворота руля направления для анимации. 

defineProperty("elev_anim_L", globalPropertyf("sim/custom/anim/elev_anim_L")) -- угол поворота руля высоты
defineProperty("elev_anim_R", globalPropertyf("sim/custom/anim/elev_anim_R")) -- угол поворота руля высоты
	
-- wings
defineProperty("wing_flx_right", globalPropertyf("sim/custom/anim/wing_flx_right")) -- угол изгиба крыла
defineProperty("wing_flx_left", globalPropertyf("sim/custom/anim/wing_flx_left")) -- угол изгиба крыла
...
defineProperty("cargo_1", globalPropertyf("sim/custom/anim/cargo_1")) -- багаж
defineProperty("cargo_2", globalPropertyf("sim/custom/anim/cargo_2")) -- багаж

defineProperty("pax_door_1", globalPropertyf("sim/custom/anim/pax_door_1")) -- двери
defineProperty("pax_door_2", globalPropertyf("sim/custom/anim/pax_door_2")) -- двери
defineProperty("pax_door_3", globalPropertyf("sim/custom/anim/pax_door_3")) -- двери

defineProperty("cockpit_door", globalPropertyf("sim/custom/anim/cockpit_door")) -- двери в кабину
defineProperty("cockpit_table_1", globalPropertyf("sim/custom/anim/cockpit_table_1")) -- столик
defineProperty("cockpit_table_2", globalPropertyf("sim/custom/anim/cockpit_table_2")) -- столик

defineProperty("rise_chair_arm_L", globalPropertyf("sim/custom/anim/rise_chair_arm_L")) -- поднять ручку кресла
defineProperty("rise_chair_arm_R", globalPropertyf("sim/custom/anim/rise_chair_arm_R")) -- поднять ручку кресла

-- yokes
defineProperty("yokes_show", globalPropertyi("sim/custom/anim/show_yokes")) -- штурвалы
...
-- tables
defineProperty("cockpit_table_1", globalPropertyf("sim/custom/anim/cockpit_table_1")) --
defineProperty("cockpit_table_2", globalPropertyf("sim/custom/anim/cockpit_table_2")) --

defineProperty("table_up_L", globalPropertyf("sim/custom/anim/table_up_L")) --
defineProperty("table_up_R", globalPropertyf("sim/custom/anim/table_up_R")) --

defineProperty("ground_stuff_angle", globalPropertyf("sim/custom/anim/ground_stuff_angle")) -- коррекция угла по тангажу для техники
...
--defineProperty("brake_L", globalPropertyf("sim/custom/SC/controls/l_brake_add")) 
--defineProperty("brake_R", globalPropertyf("sim/custom/SC/controls/r_brake_add")) 
...
-- wiper
defineProperty("wiper_left", globalPropertyi("sim/custom/switchers/wiper_left")) -- переключатель работы стеклоочистителя. -1 - медленно, 0 - выкл, +1 - быстро	0
defineProperty("wiper_right", globalPropertyi("sim/custom/switchers/wiper_right")) -- переключатель работы стеклоочистителя. -1 - медленно, 0 - выкл, +1 - быстро	0
