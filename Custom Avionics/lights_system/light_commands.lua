...
setup_toggle_command(0, 1, "sim/lights/nav_lights_toggle",   globalPropertyi("sim/custom/lights/nav_lights_set"))   -- NAV lights
setup_toggle_command(0, 1, "sim/lights/strobe_lights_toggle",   globalPropertyi("sim/custom/lights/strobe_set"))   -- Red becaon lights
setup_toggle_command(0, 1, "sim/lights/spot_lights_toggle",   globalPropertyi("sim/custom/lights/tail_light_set"))   -- tail logo
...
--setup_toggle_command(0, 1, "sasl/test_command",   globalPropertyi("sim/custom/lights/nav_lights_set"))   -- NAV lights
