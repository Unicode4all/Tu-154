...
defineProperty("white_light_left", globalPropertyi("sim/custom/lights/white_light_left")) -- светимость левого белого огня на крыле
defineProperty("white_light_right", globalPropertyi("sim/custom/lights/white_light_right")) -- светимость правого белого огня на крыле
defineProperty("beacon_light_B", globalPropertyi("sim/custom/lights/beacon_light_B")) -- светимость красного маяка
defineProperty("beacon_light_T", globalPropertyi("sim/custom/lights/beacon_light_T")) -- светимость красного маяка
...
-- controls
defineProperty("nav_lights_set", globalPropertyf("sim/custom/lights/nav_lights_set")) -- выключатель нав огней
defineProperty("strobe_set", globalPropertyf("sim/custom/lights/strobe_set")) -- выключатель красных маяков
defineProperty("wing_light_left_set", globalPropertyf("sim/custom/lights/wing_light_left_set")) -- выключатель подсвета порогов и крыла
defineProperty("wing_light_right_set", globalPropertyf("sim/custom/lights/wing_light_right_set")) -- выключатель подсвета порогов и крыла
defineProperty("tail_light_set", globalPropertyf("sim/custom/lights/tail_light_set")) -- выключатель подсвета хвоста
...
defineProperty("landing_ext_set_L", globalPropertyf("sim/custom/lights/landing_ext_set_L")) -- выпуск фар лев
defineProperty("landing_ext_set_R", globalPropertyf("sim/custom/lights/landing_ext_set_R")) -- выпуск фар прав
defineProperty("landing_mode_set_L", globalPropertyf("sim/custom/lights/landing_mode_set_L")) -- режим фар лев. -1 - рулежный, 0 - выкл, +1 - посадочный
defineProperty("landing_mode_set_R", globalPropertyf("sim/custom/lights/landing_mode_set_R")) -- режим фар прав
defineProperty("light_signal_set", globalPropertyf("sim/custom/lights/light_signal_set")) -- сигнал в полете


defineProperty("landing_light_off", globalPropertyi("sim/custom/lights/landing_light_off")) -- выключатель фар
defineProperty("landing_light_off_cap", globalPropertyi("sim/custom/lights/landing_light_off_cap")) -- выключатель фар
