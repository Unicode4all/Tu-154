...
defineProperty("cabinl_flood_set", globalPropertyf("sim/custom/lights/cabinl_flood_set")) -- выключатель освещения кабины
defineProperty("azs_panel_flood_set", globalPropertyf("sim/custom/lights/azs_panel_flood_set")) -- выключатель освещения панели АЗС


defineProperty("cargo_light_1_set", globalPropertyf("sim/custom/lights/cargo_light_1_set")) -- выключатель освещения грузового отсека
defineProperty("cargo_light_2_set", globalPropertyf("sim/custom/lights/cargo_light_2_set")) -- выключатель освещения грузового отсека
defineProperty("tech_light_set", globalPropertyf("sim/custom/lights/tech_light_set")) -- выключатель освещения технического отсека
defineProperty("gear_nacelle_light_set", globalPropertyf("sim/custom/lights/gear_nacelle_light_set")) -- выключатель освещения гондол шасси

defineProperty("nav_lights_set", globalPropertyi("sim/custom/lights/nav_lights_set")) -- выключатель нав огней
defineProperty("strobe_set", globalPropertyi("sim/custom/lights/strobe_set")) -- выключатель красных маяков
defineProperty("wing_light_left_set", globalPropertyi("sim/custom/lights/wing_light_left_set")) -- выключатель подсвета порогов и крыла
defineProperty("wing_light_right_set", globalPropertyi("sim/custom/lights/wing_light_right_set")) -- выключатель подсвета порогов и крыла
defineProperty("tail_light_set", globalPropertyi("sim/custom/lights/tail_light_set")) -- выключатель подсвета хвоста
defineProperty("day_night_set", globalPropertyi("sim/custom/lights/day_night_set")) -- переключатель день - ночь. 0 - день, 1 - ночь. приглушает яркость сигнальных ламп.
...
defineProperty("light_signal_set", globalPropertyi("sim/custom/lights/light_signal_set")) -- сигнал в полете
