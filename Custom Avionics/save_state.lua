...
defineProperty("hardware_cockpit", globalPropertyi("sim/custom/hardware_cockpit")) -- Самолет подготовлен для железного кокпита
...
defineProperty("hide_rus_objects", globalPropertyi("sim/custom/lang/hide_rus_objects")) -- спрятать русские объекты кабины
defineProperty("hide_eng_objects", globalPropertyi("sim/custom/lang/hide_eng_objects")) -- спрятать английские объекты кабины

defineProperty("sounds_voulme", globalPropertyi("sim/custom/sounds_voulme")) -- общая громкость звуков
defineProperty("enable_crew_vo", globalPropertyi("sim/custom/sounds/enable_crew_vo")) -- включены фразы екипажа
...
defineProperty("vd15_pressure_left", globalPropertyf("sim/custom/gauges/alt/vd15_pressure_left")) -- давление на ВД15 КВС
defineProperty("vd15_pressure_right", globalPropertyf("sim/custom/gauges/alt/vd15_pressure_right")) -- давление на ВД15 2П
defineProperty("vd15_pressure_eng", globalPropertyf("sim/custom/gauges/alt/vd15_pressure_eng")) -- давление на ВД15 БИ
defineProperty("uvid_pressure_knob", globalPropertyf("sim/custom/gauges/alt/uvid_pressure_knob"))  -- ручка установки давления
...
defineProperty("brake_runtime_left", globalPropertyf("sim/custom/failures/brake_runtime_left")) -- Наработка тормозных колодок
defineProperty("brake_runtime_right", globalPropertyf("sim/custom/failures/brake_runtime_right")) -- Наработка тормозных колодок
...
defineProperty("gs_qty_1", globalPropertyf("sim/custom/hydro/gs_qty_1")) -- остаток масла в системе
defineProperty("gs_qty_2", globalPropertyf("sim/custom/hydro/gs_qty_2")) -- остаток масла в системе
defineProperty("gs_qty_3", globalPropertyf("sim/custom/hydro/gs_qty_3")) -- остаток масла в системе


defineProperty("tth_left_fail", globalPropertyi("sim/custom/failures/tth_left_fail")) -- отказ турбохолодильника
defineProperty("tth_right_fail", globalPropertyi("sim/custom/failures/tth_right_fail")) -- отказ турбохолодильника
...
defineProperty("psvp_fail_left", globalPropertyi("sim/custom/failures/psvp_fail_left")) -- отказ ПСВП
defineProperty("psvp_fail_right", globalPropertyi("sim/custom/failures/psvp_fail_right")) -- отказ ПСВП
defineProperty("sard_valve_fail", globalPropertyi("sim/custom/failures/sard_valve_fail")) -- отказ выпускного клапана

defineProperty("lan_lamp_fail_FL", globalPropertyi("sim/custom/failures/lan_lamp_fail_FL")) -- отказ передней левой фары
defineProperty("lan_lamp_fail_FR", globalPropertyi("sim/custom/failures/lan_lamp_fail_FR")) -- отказ передней правой фары
defineProperty("lan_lamp_fail_WL", globalPropertyi("sim/custom/failures/lan_lamp_fail_WL")) -- отказ крыльевой левой фары
defineProperty("lan_lamp_fail_WR", globalPropertyi("sim/custom/failures/lan_lamp_fail_WR")) -- отказ крыльевой правой фары
...
defineProperty("main_alarm_fail", globalPropertyi("sim/custom/failures/main_alarm_fail")) -- отказ сирены
defineProperty("speaker_alarm_fail", globalPropertyi("sim/custom/failures/speaker_alarm_fail")) -- отказ сирены
...
defineProperty("nav1fail", globalPropertyi("sim/custom/failures/nav1_fail")) -- fail
defineProperty("nav2fail", globalPropertyi("sim/custom/failures/nav2_fail")) -- fail
defineProperty("dme1_fail", globalPropertyi("sim/custom/failures/dme1_fail")) -- fail
defineProperty("dme2_fail", globalPropertyi("sim/custom/failures/dme2_fail")) -- fail
...
defineProperty("rel_pitot", globalPropertyi("sim/custom/failures/pitot1")) -- Pitot 1 - Blockage
defineProperty("rel_pitot2", globalPropertyi("sim/custom/failures/pitot2")) -- Pitot 2 - Blockage
defineProperty("static_fail_L", globalPropertyi("sim/custom/failures/static1"))  -- static fail
defineProperty("static_fail_R", globalPropertyi("sim/custom/failures/static2"))  -- static fail
defineProperty("svs_fail", globalPropertyi("sim/operation/failures/rel_adc_comp"))  -- static fail


defineProperty("mgv_fail", globalPropertyi("sim/custom/failures/mgv_fail")) -- отказ МГВ
...
defineProperty("rv1_fail", globalPropertyi("sim/custom/failures/rv1_fail"))  -- fail
defineProperty("rv2_fail", globalPropertyi("sim/custom/failures/rv2_fail"))  -- fail
defineProperty("uap_fail", globalPropertyi("sim/custom/failures/AOA")) -- fail
defineProperty("uap_warn_fail", globalPropertyi("sim/operation/failures/rel_stall_warn")) -- fail
defineProperty("uvid_fail", globalPropertyi("sim/custom/failures/uvid15_fail")) -- fail
