...
-- controls on panel
defineProperty("cabin_sel", globalPropertyi("sim/custom/switchers/airbleed/cabin_sel")) -- выбор салона
defineProperty("cockpit_temp_set", globalPropertyi("sim/custom/switchers/airbleed/cockpit_temp_set")) -- установка температуры кабины
defineProperty("cabin1_temp_set", globalPropertyi("sim/custom/switchers/airbleed/cabin1_temp_set")) -- установка температуры салона
defineProperty("cabin2_temp_set", globalPropertyi("sim/custom/switchers/airbleed/cabin2_temp_set")) -- установка температуры салона
defineProperty("cockpit_mode_set", globalPropertyi("sim/custom/switchers/airbleed/cockpit_mode_set")) -- становка режима обогрева. 0 - нейтр. 1 - авто, 2 - хол, 3 - гор
defineProperty("cabin1_mode_set", globalPropertyi("sim/custom/switchers/airbleed/cabin1_mode_set")) -- установка режима обогрева
defineProperty("cabin2_mode_set", globalPropertyi("sim/custom/switchers/airbleed/cabin2_mode_set")) -- установка режима обогрева
defineProperty("heat_close", globalPropertyi("sim/custom/switchers/airbleed/heat_close")) -- прекращение обогрева
defineProperty("heat_close_cap", globalPropertyi("sim/custom/switchers/airbleed/heat_close_cap")) -- прекращение обогрева

defineProperty("left_sys_temp_set", globalPropertyi("sim/custom/switchers/airbleed/left_sys_temp_set")) -- установка температуры левой магистрали
defineProperty("right_sys_temp_set", globalPropertyi("sim/custom/switchers/airbleed/right_sys_temp_set")) -- установка температуры правой магистрали
defineProperty("left_sys_mode_set", globalPropertyi("sim/custom/switchers/airbleed/left_sys_mode_set")) -- установка режима левой магистрали
defineProperty("right_sys_mode_set", globalPropertyi("sim/custom/switchers/airbleed/right_sys_mode_set")) -- установка режима правой магистрали
defineProperty("ground_cond_on", globalPropertyi("sim/custom/switchers/airbleed/ground_cond_on")) -- наземное кондиционирование
defineProperty("ground_cond_on_cap", globalPropertyi("sim/custom/switchers/airbleed/ground_cond_on_cap")) -- наземное кондиционирование
defineProperty("skv_faster_work", globalPropertyi("sim/custom/switchers/airbleed/skv_faster_work")) -- охлаждение ГК, 0 - выкл, +1 - ускоренноые режимы обогрева
defineProperty("skv_faster_work_cap", globalPropertyi("sim/custom/switchers/airbleed/skv_faster_work_cap")) -- охлаждение ГК, крышка
defineProperty("sys_temp_select", globalPropertyi("sim/custom/switchers/airbleed/sys_temp_select")) -- переключение источников термометра. 0 - обогрев дверей, 1 - экип, 2 - салон 1, 3 - салон 2, 4 - маг лев, 5 - маг прав

defineProperty("psvp_left_on", globalPropertyi("sim/custom/switchers/airbleed/psvp_left_on")) -- ПСВП лев
defineProperty("psvp_right_on", globalPropertyi("sim/custom/switchers/airbleed/psvp_right_on")) -- ПСВП прав
defineProperty("psvp_left_on_cap", globalPropertyi("sim/custom/switchers/airbleed/psvp_left_on_cap")) -- ПСВП лев
defineProperty("psvp_right_on_cap", globalPropertyi("sim/custom/switchers/airbleed/psvp_right_on_cap")) -- ПСВП прав
defineProperty("air_valve_left", globalPropertyi("sim/custom/switchers/airbleed/air_valve_left")) -- краны наддува. -1 закр, 0 - нейтр, +1 откр
defineProperty("air_valve_right", globalPropertyi("sim/custom/switchers/airbleed/air_valve_right")) -- краны наддува. -1 закр, 0 - нейтр, +1 откр
defineProperty("air_valve_both", globalPropertyi("sim/custom/switchers/airbleed/air_valve_both")) -- краны наддува. -1 закр, 0 - нейтр, +1 откр
defineProperty("emerg_decompress", globalPropertyi("sim/custom/switchers/airbleed/emerg_decompress")) -- сброс давления
defineProperty("emerg_decompress_cap", globalPropertyi("sim/custom/switchers/airbleed/emerg_decompress_cap")) -- сброс давления
defineProperty("eng_valve_1", globalPropertyi("sim/custom/switchers/airbleed/eng_valve_1")) -- отбор воздуха от двигателей
defineProperty("eng_valve_2", globalPropertyi("sim/custom/switchers/airbleed/eng_valve_2")) -- отбор воздуха от двигателей
defineProperty("eng_valve_3", globalPropertyi("sim/custom/switchers/airbleed/eng_valve_3")) -- отбор воздуха от двигателей
defineProperty("dubler_on", globalPropertyi("sim/custom/switchers/airbleed/dubler_on")) -- дублер
defineProperty("dubler_on_cap", globalPropertyi("sim/custom/switchers/airbleed/dubler_on_cap")) -- дублер


defineProperty("sard_disable", globalPropertyi("sim/custom/switchers/eng/sard_disable")) -- перекрытие клапана сброса воздуха
defineProperty("sard_disable_cap", globalPropertyi("sim/custom/switchers/eng/sard_disable_cap")) -- перекрытие клапана сброса воздуха

defineProperty("door_heat", globalPropertyi("sim/custom/switchers/eng/door_heat")) -- обогрев дверей


-- buttons
defineProperty("lamp_test_srd", globalPropertyi("sim/custom/buttons/lamp_test_srd")) -- тест ламп
defineProperty("lamp_test_front", globalPropertyi("sim/custom/buttons/lamp_test_front")) -- кнопка проверки ламп на передней панели	0
...
defineProperty("srd_buzzer_test", globalPropertyf("sim/custom/buttons/eng/srd_buzzer_test")) -- проверка сирены СРД


-- lamps
defineProperty("skv_overheat", globalPropertyf("sim/custom/lights/small/skv_overheat")) -- перегрев СКВ
defineProperty("skv_overpress_left", globalPropertyf("sim/custom/lights/small/skv_overpress_left")) -- превышение давления
defineProperty("skv_overpress_right", globalPropertyf("sim/custom/lights/small/skv_overpress_right")) -- превышение давления
defineProperty("skv_tail_temp", globalPropertyf("sim/custom/lights/small/skv_tail_temp")) -- температура хв отсека велика

defineProperty("skv_bleed_fail_1", globalPropertyf("sim/custom/lights/small/skv_bleed_fail_1")) -- отказ отбора
defineProperty("skv_bleed_fail_2", globalPropertyf("sim/custom/lights/small/skv_bleed_fail_2")) -- отказ отбора
defineProperty("skv_bleed_fail_3", globalPropertyf("sim/custom/lights/small/skv_bleed_fail_3")) -- отказ отбора

defineProperty("skv_bleed_closed_1", globalPropertyf("sim/custom/lights/small/skv_bleed_closed_1")) -- отбор закрыт
defineProperty("skv_bleed_closed_2", globalPropertyf("sim/custom/lights/small/skv_bleed_closed_2")) -- отбор закрыт
defineProperty("skv_bleed_closed_3", globalPropertyf("sim/custom/lights/small/skv_bleed_closed_3")) -- отбор закрыт


defineProperty("srd_low_press", globalPropertyf("sim/custom/lights/small/srd_low_press")) -- давление кабины мало
defineProperty("srd_overpress", globalPropertyf("sim/custom/lights/small/srd_overpress")) -- перенаддув кабины
defineProperty("cockpit_p_low", globalPropertyf("sim/custom/lights/cockpit_p_low")) -- Р каб мало




-- gauges
defineProperty("cockpit_temp_gau", globalPropertyf("sim/custom/gauges/airbleed/cockpit_temp")) -- температура в кабине
defineProperty("cabin_temp_gau", globalPropertyf("sim/custom/gauges/airbleed/cabin_temp")) -- температура в салонах
defineProperty("system_temp", globalPropertyf("sim/custom/gauges/airbleed/system_temp")) -- температура в трубопроводе
defineProperty("air_flow_1", globalPropertyf("sim/custom/gauges/airbleed/air_flow_1")) -- расход воздуха. угол
defineProperty("air_flow_2", globalPropertyf("sim/custom/gauges/airbleed/air_flow_2")) -- расход воздуха. угол
...
defineProperty("air_usage_L", globalPropertyf("sim/custom/bleed/air_usage_L")) -- расход воздуха лев
defineProperty("air_usage_R", globalPropertyf("sim/custom/bleed/air_usage_R")) -- расход воздуха прав

defineProperty("door_heat_tube_t", globalPropertyf("sim/custom/bleed/door_heat_tube_t")) -- температура в трубопроводе обогрева дверей
defineProperty("cockpit_tube_t", globalPropertyf("sim/custom/bleed/cockpit_tube_t")) -- температура в трубопроводе в кабину
defineProperty("cabin1_tube_t", globalPropertyf("sim/custom/bleed/cabin1_tube_t")) -- температура в трубопроводе в салон 1
defineProperty("cabin2_tube_t", globalPropertyf("sim/custom/bleed/cabin2_tube_t")) -- температура в трубопроводе в салон 2
defineProperty("cold_tube1_t", globalPropertyf("sim/custom/bleed/cold_tube1_t")) -- температура в трубопроводе 1
defineProperty("cold_tube2_t", globalPropertyf("sim/custom/bleed/cold_tube2_t")) -- температура в трубопроводе 2

defineProperty("cockpit_temp", globalPropertyf("sim/custom/bleed/cockpit_temp")) -- температура в кабине
defineProperty("cabin_1_temp", globalPropertyf("sim/custom/bleed/cabin_1_temp")) -- температура в салоне 1
defineProperty("cabin_2_temp", globalPropertyf("sim/custom/bleed/cabin_2_temp")) -- температура в салоне 2
...
-- failures
defineProperty("airbleed_1", globalPropertyi("sim/custom/failures/airbleed_1")) -- отказ отбора воздуха от двигателя
defineProperty("airbleed_2", globalPropertyi("sim/custom/failures/airbleed_2")) -- отказ отбора воздуха от двигателя
defineProperty("airbleed_3", globalPropertyi("sim/custom/failures/airbleed_3")) -- отказ отбора воздуха от двигателя

defineProperty("main_pressure", globalPropertyi("sim/custom/alarm/main_pressure")) -- разгерметизация или перенаддув кабины
