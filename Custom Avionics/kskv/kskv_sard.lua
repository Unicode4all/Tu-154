...
defineProperty("sard_panel_lit", globalPropertyf("sim/custom/lights/sard_panel_lit")) -- светимость панели САРД
...
defineProperty("sard_abs_press_set", globalPropertyf("sim/custom/switchers/sard/sard_abs_press_set")) --установка абсолютного давления
defineProperty("sard_diff_set", globalPropertyf("sim/custom/switchers/sard/sard_diff_set")) -- установка перепада давлений
defineProperty("sard_spd_set", globalPropertyf("sim/custom/switchers/sard/sard_spd_set")) -- установка скорости работы САРД

defineProperty("emerg_decompress", globalPropertyi("sim/custom/switchers/airbleed/emerg_decompress")) -- сброс давления

defineProperty("sard_disable", globalPropertyi("sim/custom/switchers/eng/sard_disable")) -- ерекрытие клапана сброса воздуха
