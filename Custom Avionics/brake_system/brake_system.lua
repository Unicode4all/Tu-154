...
--defineProperty("l_brake_add", globalPropertyf("sim/custom/SC/controls/l_brake_add")) 
--defineProperty("r_brake_add", globalPropertyf("sim/custom/SC/controls/r_brake_add")) 
...
-- controls
defineProperty("gear_blocks", globalPropertyf("sim/custom/anim/gear_blocks")) -- Parking Brake
...
defineProperty("int_brakes_L", globalPropertyf("sim/custom/brakes/int_brakes_L")) -- реальное положение тормоза
defineProperty("int_brakes_R", globalPropertyf("sim/custom/brakes/int_brakes_R")) -- реальное положение тормоза

--defineProperty("int_brakes_L", globalPropertyf("sim/custom/SC/brakes/int_brakes_L")) 
--defineProperty("int_brakes_R", globalPropertyf("sim/custom/SC/brakes/int_brakes_R")) 
...
-- failures
defineProperty("brake_heat_left", globalPropertyf("sim/custom/failures/brake_heat_left")) -- Температура тормозов
defineProperty("brake_heat_right", globalPropertyf("sim/custom/failures/brake_heat_right")) -- Температура тормозов
