...
-- controls
defineProperty("lamp_test", globalPropertyi("sim/custom/buttons/lamp_test_fire_panel")) -- кнопка проверки ламп на пожарной панели	0
defineProperty("lamp_test_2", globalPropertyi("sim/custom/buttons/lamp_test_engines")) -- кнопка проверки ламп на пожарной панели	0
defineProperty("smoke_test", globalPropertyi("sim/custom/buttons/eng/smoke_test")) -- проверка датчиков дыма
defineProperty("ext_test", globalPropertyi("sim/custom/buttons/eng/ext_test")) -- проверка огнетушителей


defineProperty("lamp_test_front", globalPropertyi("sim/custom/buttons/lamp_test_front")) -- кнопка проверки ламп передней панели

defineProperty("fire_ext_1", globalPropertyi("sim/custom/buttons/eng/fire_ext_1")) -- очередь тушения пожара
defineProperty("fire_ext_2", globalPropertyi("sim/custom/buttons/eng/fire_ext_2")) -- очередь тушения пожара
defineProperty("fire_ext_3", globalPropertyi("sim/custom/buttons/eng/fire_ext_3")) -- очередь тушения пожара
defineProperty("cold_eng_1", globalPropertyi("sim/custom/buttons/eng/cold_eng_1")) -- подача хладона
defineProperty("cold_eng_2", globalPropertyi("sim/custom/buttons/eng/cold_eng_2")) -- подача хладона
defineProperty("cold_eng_3", globalPropertyi("sim/custom/buttons/eng/cold_eng_3")) -- подача хладона
defineProperty("cold_apu", globalPropertyi("sim/custom/buttons/eng/cold_apu")) -- подача хладона
defineProperty("neutral_gas", globalPropertyi("sim/custom/buttons/eng/neutral_gas")) -- нейтральный газ

defineProperty("fire_sensor_sel", globalPropertyi("sim/custom/switchers/eng/fire_sensor_sel")) -- выбор группы датчиков
defineProperty("fire_place_sel", globalPropertyi("sim/custom/switchers/eng/fire_place_sel")) -- выбор отсека

defineProperty("fire_main_switch", globalPropertyi("sim/custom/switchers/eng/fire_main_switch")) -- выключатель пожарной системы
defineProperty("fire_buzzer", globalPropertyi("sim/custom/switchers/eng/fire_buzzer")) -- пожарная сирена
defineProperty("fire_buzzer_cap", globalPropertyi("sim/custom/switchers/eng/fire_buzzer_cap")) -- пожарная сирена

-- lamps
defineProperty("smoke_1", globalPropertyf("sim/custom/lights/fire/smoke_1")) -- дым в отсеках
defineProperty("smoke_2", globalPropertyf("sim/custom/lights/fire/smoke_2")) -- дым в отсеках
defineProperty("smoke_zone2_left", globalPropertyf("sim/custom/lights/fire/smoke_zone2_left")) -- дым в отсеках
defineProperty("smoke_zone2_right", globalPropertyf("sim/custom/lights/fire/smoke_zone2_right")) -- дым в отсеках
defineProperty("smoke_zone3", globalPropertyf("sim/custom/lights/fire/smoke_zone3")) -- дым в отсеках
defineProperty("smoke_zone4", globalPropertyf("sim/custom/lights/fire/smoke_zone4")) -- дым в отсеках
defineProperty("smoke_zone5_left", globalPropertyf("sim/custom/lights/fire/smoke_zone5_left")) -- дым в отсеках
defineProperty("smoke_zone5_right", globalPropertyf("sim/custom/lights/fire/smoke_zone5_right")) -- дым в отсеках
defineProperty("smoke_zone6", globalPropertyf("sim/custom/lights/fire/smoke_zone6")) -- дым в отсеках

defineProperty("fire_eng_1", globalPropertyf("sim/custom/lights/fire/fire_eng_1")) -- пожар в двигателе
defineProperty("fire_eng_2", globalPropertyf("sim/custom/lights/fire/fire_eng_2")) -- пожар в двигателе
defineProperty("fire_eng_3", globalPropertyf("sim/custom/lights/fire/fire_eng_3")) -- пожар в двигателе

defineProperty("overheat_eng_1", globalPropertyf("sim/custom/lights/fire/overheat_eng_1")) -- перегрев двигателя
defineProperty("overheat_eng_2", globalPropertyf("sim/custom/lights/fire/overheat_eng_2")) -- перегрев двигателя
defineProperty("overheat_eng_3", globalPropertyf("sim/custom/lights/fire/overheat_eng_3")) -- перегрев двигателя

defineProperty("fuel_off_eng_1", globalPropertyf("sim/custom/lights/fire/fuel_off_eng_1")) -- топливо закрыто
defineProperty("fuel_off_eng_2", globalPropertyf("sim/custom/lights/fire/fuel_off_eng_2")) -- топливо закрыто
defineProperty("fuel_off_eng_3", globalPropertyf("sim/custom/lights/fire/fuel_off_eng_3")) -- топливо закрыто

defineProperty("check_overheat", globalPropertyf("sim/custom/lights/fire/check_overheat")) -- проверь перегрев и дым
defineProperty("fire_apu", globalPropertyf("sim/custom/lights/fire/fire_apu")) -- пожар ВСУ
defineProperty("turn_on_spz", globalPropertyf("sim/custom/lights/fire/turn_on_spz")) -- включи СПЗ


defineProperty("button_fire_eng_1", globalPropertyf("sim/custom/lights/button/fire_eng_1")) -- тушение пожара двиг 1
defineProperty("button_fire_eng_2", globalPropertyf("sim/custom/lights/button/fire_eng_2")) -- тушение пожара двиг 2
defineProperty("button_fire_eng_3", globalPropertyf("sim/custom/lights/button/fire_eng_3")) -- тушение пожара двиг 3
defineProperty("button_fire_apu", globalPropertyf("sim/custom/lights/button/fire_apu")) -- тушение пожара ВСУ
defineProperty("button_fire_ng", globalPropertyf("sim/custom/lights/button/fire_ng")) -- тушение пожара НГ
defineProperty("button_fire_turn_3", globalPropertyf("sim/custom/lights/button/fire_turn_3")) -- тушение пожара двиг 1
defineProperty("button_fire_turn_2", globalPropertyf("sim/custom/lights/button/fire_turn_2")) -- тушение пожара двиг 1
defineProperty("button_fire_turn_1", globalPropertyf("sim/custom/lights/button/fire_turn_1")) -- тушение пожара двиг 1


defineProperty("throttle_1_fire", globalPropertyf("sim/custom/lights/small/throttle_1_fire")) -- лампа пожара на РУД
defineProperty("throttle_2_fire", globalPropertyf("sim/custom/lights/small/throttle_2_fire")) -- лампа пожара на РУД
defineProperty("throttle_3_fire", globalPropertyf("sim/custom/lights/small/throttle_3_fire")) -- лампа пожара на РУД

defineProperty("fire_lamp", globalPropertyf("sim/custom/lights/fire")) -- ПОЖАР



defineProperty("eng1_dangerous_vibro", globalPropertyf("sim/custom/lights/engines/eng1_dangerous_vibro")) -- опасная вибрация
defineProperty("eng2_dangerous_vibro", globalPropertyf("sim/custom/lights/engines/eng2_dangerous_vibro")) -- опасная вибрация
defineProperty("eng3_dangerous_vibro", globalPropertyf("sim/custom/lights/engines/eng3_dangerous_vibro")) -- опасная вибрация
...
defineProperty("ext_used_1", globalPropertyi("sim/custom/fire/ext_used_1")) -- огнетушитель использован
defineProperty("ext_used_2", globalPropertyi("sim/custom/fire/ext_used_2")) -- огнетушитель использован
defineProperty("ext_used_3", globalPropertyi("sim/custom/fire/ext_used_3")) -- огнетушитель использован

defineProperty("ng_used", globalPropertyi("sim/custom/fire/ng_used")) -- НГ использован

defineProperty("valve_open_1", globalPropertyi("sim/custom/fire/valve_open_1")) -- кран тушения двиг 1
defineProperty("valve_open_2", globalPropertyi("sim/custom/fire/valve_open_2")) -- кран тушения двиг 2
defineProperty("valve_open_3", globalPropertyi("sim/custom/fire/valve_open_3")) -- кран тушения двиг 3
defineProperty("valve_open_4", globalPropertyi("sim/custom/fire/valve_open_4")) -- кран тушения ВСУ

defineProperty("engine_fire_state_1", globalPropertyi("sim/custom/fire/engine_fire_state_1")) -- состояние двигателя. 0 - норм, 1 - перегрев, 2 - пожар
defineProperty("engine_fire_state_2", globalPropertyi("sim/custom/fire/engine_fire_state_2")) -- состояние двигателя. 0 - норм, 1 - перегрев, 2 - пожар
defineProperty("engine_fire_state_3", globalPropertyi("sim/custom/fire/engine_fire_state_3")) -- состояние двигателя. 0 - норм, 1 - перегрев, 2 - пожар
defineProperty("engine_fire_state_4", globalPropertyi("sim/custom/fire/engine_fire_state_4")) -- состояние ВСУ. 0 - норм, 1 - перегрев, 2 - пожар

defineProperty("engine_fuel_cut_1", globalPropertyi("sim/custom/fire/engine_fuel_cut_1")) -- топливо перекрыто
defineProperty("engine_fuel_cut_2", globalPropertyi("sim/custom/fire/engine_fuel_cut_2")) -- топливо перекрыто
defineProperty("engine_fuel_cut_3", globalPropertyi("sim/custom/fire/engine_fuel_cut_3")) -- топливо перекрыто
...
defineProperty("fire_detected", globalPropertyi("sim/custom/fire/fire_detected")) -- обнаружен пожар
defineProperty("fire_siren", globalPropertyi("sim/custom/fire/fire_siren")) -- работа сирены
