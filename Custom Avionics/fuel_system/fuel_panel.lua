...
-- gauges
defineProperty("fuel_meter_summ", globalPropertyf("sim/custom/gauges/fuel/fuel_meter_summ")) -- сумарная масса топлива
defineProperty("fuel_meter_tank1", globalPropertyf("sim/custom/gauges/fuel/fuel_meter_tank1")) -- масса топлива в баке 1
defineProperty("fuel_meter_tank2_left", globalPropertyf("sim/custom/gauges/fuel/fuel_meter_tank2_left")) -- масса топлива в баке 2
defineProperty("fuel_meter_tank2_right", globalPropertyf("sim/custom/gauges/fuel/fuel_meter_tank2_right")) -- масса топлива в баке 2
defineProperty("fuel_meter_tank3_left", globalPropertyf("sim/custom/gauges/fuel/fuel_meter_tank3_left")) -- масса топлива в баке 3
defineProperty("fuel_meter_tank3_right", globalPropertyf("sim/custom/gauges/fuel/fuel_meter_tank3_right")) -- масса топлива в баке 3
defineProperty("fuel_meter_tank4", globalPropertyf("sim/custom/gauges/fuel/fuel_meter_tank4")) -- масса топлива в баке 4
defineProperty("fuel_meter_mech", globalPropertyf("sim/custom/gauges/fuel/fuel_meter_mech")) -- расходомер
defineProperty("fuel_front_ind", globalPropertyf("sim/custom/gauges/misc/fuel_front_ind")) -- индикатор топлива на передней панели


-- controls on gauges
defineProperty("fuel_meter_summ_zero", globalPropertyf("sim/custom/buttons/fuel/fuel_meter_summ_zero")) -- сумарная масса топлива. кнопка нуля
defineProperty("fuel_meter_summ_max", globalPropertyf("sim/custom/buttons/fuel/fuel_meter_summ_max")) -- сумарная масса топлива. кнопка P
defineProperty("fuel_meter_tank2_zero", globalPropertyf("sim/custom/buttons/fuel/fuel_meter_tank2_zero")) -- топливомер бака 2. кнопка нуля
defineProperty("fuel_meter_tank2_max", globalPropertyf("sim/custom/buttons/fuel/fuel_meter_tank2_max")) -- стопливомер бака 2. кнопка P
defineProperty("fuel_meter_tank3_zero", globalPropertyf("sim/custom/buttons/fuel/fuel_meter_tank3_zero")) -- топливомер бака 3. кнопка нуля
defineProperty("fuel_meter_tank3_max", globalPropertyf("sim/custom/buttons/fuel/fuel_meter_tank3_max")) -- топливомер бака 3. кнопка P
defineProperty("fuel_meter_tank4_zero", globalPropertyf("sim/custom/buttons/fuel/fuel_meter_tank4_zero")) -- топливомер бака 4. кнопка нуля
defineProperty("fuel_meter_tank4_max", globalPropertyf("sim/custom/buttons/fuel/fuel_meter_tank4_max")) -- топливомер бака 4. кнопка P
defineProperty("fuel_front_zero", globalPropertyf("sim/custom/buttons/misc/fuel_front_zero")) -- индикатор топлива на передней панели.кнопка нуля
defineProperty("fuel_front_max", globalPropertyf("sim/custom/buttons/misc/fuel_front_max")) -- индикатор топлива на передней панели.кнопка макс


-- controls
defineProperty("pump_tank2_left", globalPropertyi("sim/custom/switchers/fuel/pump_tank2_left")) -- насосы бака 2
defineProperty("pump_tank2_right", globalPropertyi("sim/custom/switchers/fuel/pump_tank2_right")) -- насосы бака 2
defineProperty("pump_tank3_left", globalPropertyi("sim/custom/switchers/fuel/pump_tank3_left")) -- насосы бака 3
defineProperty("pump_tank3_right", globalPropertyi("sim/custom/switchers/fuel/pump_tank3_right")) -- насосы бака 3
defineProperty("pump_tank4", globalPropertyi("sim/custom/switchers/fuel/pump_tank4")) -- насосы бака 4
defineProperty("pump_tank1_1", globalPropertyi("sim/custom/switchers/fuel/pump_tank1_1")) -- насосы бака 1
defineProperty("pump_tank1_2", globalPropertyi("sim/custom/switchers/fuel/pump_tank1_2")) -- насосы бака 1
defineProperty("pump_tank1_3", globalPropertyi("sim/custom/switchers/fuel/pump_tank1_3")) -- насосы бака 1
defineProperty("pump_tank1_4", globalPropertyi("sim/custom/switchers/fuel/pump_tank1_4")) -- насосы бака 1

defineProperty("fuel_trans", globalPropertyi("sim/custom/switchers/fuel/fuel_trans")) -- краны резервой перекачки
defineProperty("fuel_trans_cap", globalPropertyi("sim/custom/switchers/fuel/fuel_trans_cap")) -- краны резервой перекачки
defineProperty("fuel_porc", globalPropertyi("sim/custom/switchers/fuel/fuel_porc")) -- принуд порц
defineProperty("fuel_porc_cap", globalPropertyi("sim/custom/switchers/fuel/fuel_porc_cap")) -- принуд порц
defineProperty("fuel_level", globalPropertyi("sim/custom/switchers/fuel/fuel_level")) -- автомат выравнивания
defineProperty("fuel_flow_mode", globalPropertyi("sim/custom/switchers/fuel/fuel_flow_mode")) -- режим топлвиной системы. ручное - автомат
defineProperty("fuel_flow_on", globalPropertyi("sim/custom/switchers/fuel/fuel_flow_on")) -- автомат расхода
defineProperty("fuel_flow_on_cap", globalPropertyi("sim/custom/switchers/fuel/fuel_flow_on_cap")) -- автомат расхода

defineProperty("fuel_meter_on", globalPropertyi("sim/custom/switchers/fuel/fuel_meter_on")) -- топливомер
defineProperty("fuel_meter_mech_on", globalPropertyi("sim/custom/switchers/fuel/fuel_meter_mech_on")) -- расходомер
...
defineProperty("fire_valve_1_cap", globalPropertyi("sim/custom/switchers/fuel/fire_valve_1_cap")) -- пожарный кран
defineProperty("fire_valve_2_cap", globalPropertyi("sim/custom/switchers/fuel/fire_valve_2_cap")) -- пожарный кран
defineProperty("fire_valve_3_cap", globalPropertyi("sim/custom/switchers/fuel/fire_valve_3_cap")) -- пожарный кран

defineProperty("reserv_pump_test", globalPropertyi("sim/custom/buttons/eng/reserv_pump_test")) -- кнопка проверки резерв насоса


-- lamps
defineProperty("fuel_2500", globalPropertyf("sim/custom/lights/small/fuel_2500")) -- остаток топлива 2500
defineProperty("fuel_tank1_used", globalPropertyf("sim/custom/lights/small/fuel_tank1_used")) -- расход из бака 1
defineProperty("fuel_tank3_left_fail", globalPropertyf("sim/custom/lights/small/fuel_tank3_left_fail")) -- красная лампа бака 3 лев
defineProperty("fuel_tank2_left_fail", globalPropertyf("sim/custom/lights/small/fuel_tank2_left_fail")) -- красная лампа бака 2 лев
defineProperty("fuel_tank2_right_fail", globalPropertyf("sim/custom/lights/small/fuel_tank2_right_fail")) -- красная лампа бака 2 прав
defineProperty("fuel_tank3_right_fail", globalPropertyf("sim/custom/lights/small/fuel_tank3_right_fail")) -- красная лампа бака 3 прав

defineProperty("fuel_pump_left_5", globalPropertyf("sim/custom/lights/small/fuel_pump_left_5")) -- насос бака 5 лев
defineProperty("fuel_pump_left_6", globalPropertyf("sim/custom/lights/small/fuel_pump_left_6")) -- насос бака 6 лев
defineProperty("fuel_pump_left_7", globalPropertyf("sim/custom/lights/small/fuel_pump_left_7")) -- насос бака 7 лев
defineProperty("fuel_pump_left_8", globalPropertyf("sim/custom/lights/small/fuel_pump_left_8")) -- насос бака 8 лев
defineProperty("fuel_pump_left_9", globalPropertyf("sim/custom/lights/small/fuel_pump_left_9")) -- насос бака 9 лев

defineProperty("fuel_pump_right_5", globalPropertyf("sim/custom/lights/small/fuel_pump_right_5")) -- насос бака 5 прав
defineProperty("fuel_pump_right_6", globalPropertyf("sim/custom/lights/small/fuel_pump_right_6")) -- насос бака 6 прав
defineProperty("fuel_pump_right_7", globalPropertyf("sim/custom/lights/small/fuel_pump_right_7")) -- насос бака 7 прав
defineProperty("fuel_pump_right_8", globalPropertyf("sim/custom/lights/small/fuel_pump_right_8")) -- насос бака 8 прав
defineProperty("fuel_pump_right_9", globalPropertyf("sim/custom/lights/small/fuel_pump_right_9")) -- насос бака 9 прав

defineProperty("fuel_pump_10", globalPropertyf("sim/custom/lights/small/fuel_pump_10")) -- насос бака 10 прав
defineProperty("fuel_pump_11", globalPropertyf("sim/custom/lights/small/fuel_pump_11")) -- насос бака 11 прав
defineProperty("fuel_pump_1", globalPropertyf("sim/custom/lights/small/fuel_pump_1")) -- насос бака 1 прав
defineProperty("fuel_pump_2", globalPropertyf("sim/custom/lights/small/fuel_pump_2")) -- насос бака 2 прав
defineProperty("fuel_pump_3", globalPropertyf("sim/custom/lights/small/fuel_pump_3")) -- насос бака 3 прав
defineProperty("fuel_pump_4", globalPropertyf("sim/custom/lights/small/fuel_pump_4")) -- насос бака 4 прав


defineProperty("fuel_cut_off_1", globalPropertyf("sim/custom/lights/small/fuel_cut_off_1")) -- перекрывные краны
defineProperty("fuel_cut_off_2", globalPropertyf("sim/custom/lights/small/fuel_cut_off_2")) -- перекрывные краны
defineProperty("fuel_cut_off_3", globalPropertyf("sim/custom/lights/small/fuel_cut_off_3")) -- перекрывные краны
defineProperty("fuel_flow_from_2", globalPropertyf("sim/custom/lights/small/fuel_flow_from_2")) -- порядок расхода
defineProperty("fuel_flow_from_3", globalPropertyf("sim/custom/lights/small/fuel_flow_from_3")) -- порядок расхода
defineProperty("fuel_flow_from_4", globalPropertyf("sim/custom/lights/small/fuel_flow_from_4")) -- порядок расхода

defineProperty("fuel_flow_auto_fail", globalPropertyf("sim/custom/lights/small/fuel_flow_auto_fail")) -- автомат расхода не работает
defineProperty("fuel_reserv_trans_left", globalPropertyf("sim/custom/lights/small/fuel_reserv_trans_left")) -- резервная перекачка в бак 1 
defineProperty("fuel_reserv_trans_right", globalPropertyf("sim/custom/lights/small/fuel_reserv_trans_right")) -- резервная перекачка в бак 1 
defineProperty("fuel_porc_reserv", globalPropertyf("sim/custom/lights/small/fuel_porc_reserv")) -- порцевание
defineProperty("fuel_level_automat", globalPropertyf("sim/custom/lights/small/fuel_level_automat")) -- автомат выравнивания
...
-- lamps sources
defineProperty("test_lamps", globalPropertyi("sim/custom/buttons/lamp_test_hydro")) -- кнопка првоерки ламп панели ВСУ
...
defineProperty("auto_tanks_turn", globalPropertyi("sim/custom/fuel/auto_tanks_turn")) -- рабочие очередные баки. 0, 1 - не работает, 2, 3, 4	0
--defineProperty("auto_tank_level", globalPropertyi("sim/custom/fuel/auto_tank_level")) -- выравнивание в баках. -2 - 2L, -3 - 3L, +3 - 3R, +2 - 2R	0

defineProperty("auto_tank_level_2", globalPropertyi("sim/custom/fuel/auto_tank_level_2")) -- выравнивание в баках 2. -1 = L, 0 = none, +1 = R	0
defineProperty("auto_tank_level_3", globalPropertyi("sim/custom/fuel/auto_tank_level_3")) -- выравнивание в баках 3. -1 = L, 0 = none, +1 = R	0
...
defineProperty("fuel_pump_2l_fail", globalPropertyi("sim/custom/failures/fuel_pump_2l_fail")) -- number of failed pumps
