...
defineProperty("paylod_set", globalPropertyf("sim/custom/payload/paylod_set")) -- Нужно загрузить
defineProperty("cg_set", globalPropertyf("sim/custom/payload/cg_set")) -- Нужно загрузить

defineProperty("load_fuel_btn",globalPropertyi("sim/custom/payload/load_fuel_btn")) -- кнопка загрузки топлива
defineProperty("load_fast_btn",globalPropertyi("sim/custom/payload/load_fast_btn")) -- кнопка загрузки
defineProperty("load_slow_btn",globalPropertyi("sim/custom/payload/load_slow_btn")) -- кнопка загрузки
