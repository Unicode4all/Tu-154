...
defineProperty("hide_eng_objects", globalPropertyi("sim/custom/lang/hide_eng_objects")) -- спрятать английские объекты кабины. 1 = RUS

defineProperty("show_ohvd_panel",globalPropertyi("sim/custom/panels/show_ohvd_panel")) -- показать панель верхней панели

-- switchers
defineProperty("var_left", globalPropertyi("sim/custom/switchers/ovhd/var_left"))  -- оерхед. вар лев
defineProperty("var_right", globalPropertyi("sim/custom/switchers/ovhd/var_right"))  -- оерхед. вар прав
defineProperty("auasp_on", globalPropertyi("sim/custom/switchers/ovhd/auasp_on"))  -- оерхед. АУАСП
defineProperty("auasp_contr", globalPropertyi("sim/custom/switchers/ovhd/auasp_contr"))  -- оерхед. АУАСП контроль
defineProperty("eup_on", globalPropertyi("sim/custom/switchers/ovhd/eup_on"))  -- выключатель ЭУП
defineProperty("agr_on", globalPropertyi("sim/custom/switchers/ovhd/agr_on"))  -- выключатель АГР
defineProperty("bkk_contr", globalPropertyi("sim/custom/switchers/ovhd/bkk_contr"))  -- контроль БКК. -1 - 2, 0 - выкл, +1 - 1
defineProperty("bkk_on", globalPropertyi("sim/custom/switchers/ovhd/bkk_on"))  -- выключатель БКК
defineProperty("sau_stu_on", globalPropertyi("sim/custom/switchers/ovhd/sau_stu_on"))  -- САУ СТУ выключатель
defineProperty("pkp_left_on", globalPropertyi("sim/custom/switchers/ovhd/pkp_left_on"))  -- ПКП лев	
defineProperty("pkp_right_on", globalPropertyi("sim/custom/switchers/ovhd/pkp_right_on"))  -- 	ПКП прав
defineProperty("mgv_contr", globalPropertyi("sim/custom/switchers/ovhd/mgv_contr"))  -- контроль МГВ
defineProperty("tks_on_1", globalPropertyi("sim/custom/switchers/ovhd/tks_on_1"))  -- выключатель ТКС 1
defineProperty("tks_on_2", globalPropertyi("sim/custom/switchers/ovhd/tks_on_2"))  -- выключатель ТКС 2
defineProperty("tks_heat", globalPropertyi("sim/custom/switchers/ovhd/tks_heat"))  -- обогрев ГА
defineProperty("tks_corr_1", globalPropertyi("sim/custom/switchers/ovhd/tks_corr_1"))  -- коррекция БГМК 2 - 1
defineProperty("tks_corr_2", globalPropertyi("sim/custom/switchers/ovhd/tks_corr_2"))  -- коррекция БГМК 2 - 2
defineProperty("curs_pnp_mode_1", globalPropertyi("sim/custom/switchers/ovhd/curs_pnp_mode_1"))  -- режим курс ПНП. 0 - ГМК, 1 - ГПК
defineProperty("curs_pnp_mode_2", globalPropertyi("sim/custom/switchers/ovhd/curs_pnp_mode_2"))  -- режим курс ПНП. 0 - ГМК, 1 - ГПК
defineProperty("svs_on", globalPropertyi("sim/custom/switchers/ovhd/svs_on"))  -- выключатель СВС
defineProperty("svs_heat", globalPropertyi("sim/custom/switchers/ovhd/svs_heat"))  -- обогрев СВС
defineProperty("kln_on", globalPropertyi("sim/custom/switchers/ovhd/kln_on"))  -- выключатель КЛН

---
defineProperty("tcas_on", globalPropertyi("sim/custom/switchers/ovhd/tcas_on"))  -- выключатель TCAS
defineProperty("emerg_light_on", globalPropertyi("sim/custom/switchers/ovhd/emerg_light_on"))  -- аварийное освещение
defineProperty("curs_np_on_1", globalPropertyi("sim/custom/switchers/ovhd/curs_np_on_1"))  -- курс МП 1
defineProperty("curs_np_on_2", globalPropertyi("sim/custom/switchers/ovhd/curs_np_on_2"))  -- курс МП 2
defineProperty("tra_67_on", globalPropertyi("sim/custom/switchers/ovhd/tra_67_on"))  -- ТРА 67
defineProperty("rsbn_on", globalPropertyi("sim/custom/switchers/ovhd/rsbn_on"))  -- РСБН питание
defineProperty("rsbn_recon", globalPropertyi("sim/custom/switchers/ovhd/rsbn_recon"))  -- РСБН опознавание
defineProperty("rv5_1_on", globalPropertyi("sim/custom/switchers/ovhd/rv5_1_on"))  -- РВ5 1
defineProperty("rv5_2_on", globalPropertyi("sim/custom/switchers/ovhd/rv5_2_on"))  -- РВ5 2
defineProperty("vhf_1_on", globalPropertyi("sim/custom/switchers/ovhd/vhf_1_on"))  -- УКВ 1
defineProperty("vhf_2_on", globalPropertyi("sim/custom/switchers/ovhd/vhf_2_on"))  -- УКВ 2
...
defineProperty("micron_1_on", globalPropertyi("sim/custom/switchers/ovhd/micron_1_on"))  -- микрон 1
defineProperty("micron_2_on", globalPropertyi("sim/custom/switchers/ovhd/micron_2_on"))  -- микрон 2
defineProperty("spu_on", globalPropertyi("sim/custom/switchers/ovhd/spu_on"))  -- СПУ
defineProperty("sgs_on", globalPropertyi("sim/custom/switchers/ovhd/sgs_on"))  -- СГС
defineProperty("sd75_1_on", globalPropertyi("sim/custom/switchers/ovhd/sd75_1_on"))  -- СД75 1
defineProperty("sd75_2_on", globalPropertyi("sim/custom/switchers/ovhd/sd75_2_on"))  -- СД75 2
---
defineProperty("uvid_on", globalPropertyi("sim/custom/switchers/ovhd/uvid_on"))  -- выключатель УВИД
defineProperty("vbe_1_on", globalPropertyi("sim/custom/switchers/ovhd/vbe_1_on"))  -- ВБЭ 1
defineProperty("vbe_2_on", globalPropertyi("sim/custom/switchers/ovhd/vbe_2_on"))  -- ВБЭ 2
defineProperty("mars_on", globalPropertyi("sim/custom/switchers/ovhd/mars_on"))  -- МАРС

defineProperty("vent_1", globalPropertyi("sim/custom/switchers/ovhd/vent_1"))  -- вентилятор КВС
defineProperty("vent_2", globalPropertyi("sim/custom/switchers/ovhd/vent_2"))  -- вентилятор 2П
defineProperty("vent_3", globalPropertyi("sim/custom/switchers/ovhd/vent_3"))  -- вентилятор БИ

defineProperty("arm406", globalPropertyi("sim/custom/switchers/ovhd/arm406"))  -- АРМ 406
defineProperty("ushdb_mode_1", globalPropertyi("sim/custom/switchers/ovhd/ushdb_mode_1"))  -- УШДБ и СПУ 1. 0 - АРК, 1 - VOR
defineProperty("ushdb_mode_2", globalPropertyi("sim/custom/switchers/ovhd/ushdb_mode_2"))  -- УШДБ и СПУ 2. 0 - АРК, 1 - VOR

defineProperty("diss_on", globalPropertyi("sim/custom/switchers/ovhd/diss_on")) -- питание ДИСС
defineProperty("diss_mode", globalPropertyi("sim/custom/switchers/ovhd/diss_mode")) -- режим дисс. 0 - море, 1 - суша
defineProperty("nvu_calc_set", globalPropertyi("sim/custom/switchers/ovhd/nvu_calc_set")) -- счисление. -1 - контроль ДИСС в полете, 0 - НВУ по СВС, 1 - НВУ по ДИСС
...
defineProperty("egpws_alarm_1", globalPropertyi("sim/custom/switchers/ovhd/egpws_alarm_1")) -- сигнализация СРПБЗ общ
defineProperty("egpws_alarm_2", globalPropertyi("sim/custom/switchers/ovhd/egpws_alarm_2")) -- сигнализация СРПБЗ
defineProperty("egpws_relief", globalPropertyi("sim/custom/switchers/ovhd/egpws_relief")) -- рельеф
defineProperty("egpws_mode", globalPropertyi("sim/custom/switchers/ovhd/egpws_mode")) -- QNH - QFE
...
-- buttons
defineProperty("tks_signal_off", globalPropertyi("sim/custom/buttons/ovhd/tks_signal_off"))  -- снятие блокировки сигнала ТКС
defineProperty("svs_contr", globalPropertyi("sim/custom/buttons/ovhd/svs_contr"))  -- кнопка контроля СВС

defineProperty("egpws_control", globalPropertyi("sim/custom/buttons/ovhd/egpws_control")) -- кнопка контроля СРПБЗ
defineProperty("egpws_contr_gs", globalPropertyi("sim/custom/buttons/ovhd/egpws_contr_gs")) -- контроль СРПБЗ глиссада
...
defineProperty("nav_1_left", globalPropertyi("sim/custom/rotary/ovhd/nav_1_left")) -- левая крутилка
defineProperty("nav_1_right", globalPropertyi("sim/custom/rotary/ovhd/nav_1_right")) -- правая крутилка

defineProperty("nav_1_mile_km", globalPropertyi("sim/custom/switchers/nav_1_mile_km")) -- режим мили - км

defineProperty("nav_1_but_1", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_1")) -- кнопка 1
defineProperty("nav_1_but_2", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_2")) -- кнопка 2
defineProperty("nav_1_but_3", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_3")) -- кнопка 3


defineProperty("nav_2", globalPropertyf("sim/cockpit2/radios/actuators/nav2_frequency_hz"))  -- set the frequency
defineProperty("nav_2_left", globalPropertyi("sim/custom/rotary/ovhd/nav_2_left")) -- левая крутилка
defineProperty("nav_2_right", globalPropertyi("sim/custom/rotary/ovhd/nav_2_right")) -- правая крутилка

defineProperty("nav_2_mile_km", globalPropertyi("sim/custom/switchers/nav_2_mile_km")) -- режим мили - км

defineProperty("nav_2_but_1", globalPropertyi("sim/custom/buttons/ovhd/nav_2_but_1")) -- кнопка 1
defineProperty("nav_2_but_2", globalPropertyi("sim/custom/buttons/ovhd/nav_2_but_2")) -- кнопка 2
defineProperty("nav_2_but_3", globalPropertyi("sim/custom/buttons/ovhd/nav_2_but_3")) -- кнопка 3

-- VHF
defineProperty("vhf_1", globalPropertyf("sim/cockpit2/radios/actuators/com1_frequency_hz"))  -- set the frequency
defineProperty("vhf_1_left", globalPropertyi("sim/custom/rotary/ovhd/vhf_1_left"))  -- knob
defineProperty("vhf_1_right", globalPropertyi("sim/custom/rotary/ovhd/vhf_1_right"))  -- knob

defineProperty("vhf_2", globalPropertyf("sim/cockpit2/radios/actuators/com2_frequency_hz"))  -- set the frequency
defineProperty("vhf_2_left", globalPropertyi("sim/custom/rotary/ovhd/vhf_2_left"))  -- knob
defineProperty("vhf_2_right", globalPropertyi("sim/custom/rotary/ovhd/vhf_2_right"))  -- knob

-- ARK
defineProperty("ark_1_mode", globalPropertyi("sim/custom/switchers/ovhd/ark_1_mode")) -- режим АРК 1 0 - выкл, 1 - комп, 2 - ант, 3 - рам
defineProperty("ark_1_channel", globalPropertyi("sim/custom/switchers/ovhd/ark_1_channel")) -- канал АРК 1
defineProperty("ark_1_hundr_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_hundr_left")) -- сотни частоты 1 - 17
defineProperty("ark_1_tens_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_tens_left")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_1_ones_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_ones_left")) -- единицы частоты 0 - 9
defineProperty("ark_1_hundr_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_hundr_right")) -- сотни частоты 1 - 17
defineProperty("ark_1_tens_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_tens_right")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_1_ones_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_ones_right")) -- единицы частоты 0 - 9

defineProperty("ark_1_ramka", globalPropertyi("sim/custom/buttons/ovhd/ark_1_ramka")) -- кнопка рамки


defineProperty("ark_2_mode", globalPropertyi("sim/custom/switchers/ovhd/ark_2_mode")) -- режим АРК 1 0 - выкл, 1 - комп, 2 - ант, 3 - рам
defineProperty("ark_2_channel", globalPropertyi("sim/custom/switchers/ovhd/ark_2_channel")) -- канал АРК 1
defineProperty("ark_2_hundr_left", globalPropertyi("sim/custom/switchers/ovhd/ark_2_hundr_left")) -- сотни частоты 1 - 17
defineProperty("ark_2_tens_left", globalPropertyi("sim/custom/switchers/ovhd/ark_2_tens_left")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_2_ones_left", globalPropertyi("sim/custom/switchers/ovhd/ark_2_ones_left")) -- единицы частоты 0 - 9
defineProperty("ark_2_hundr_right", globalPropertyi("sim/custom/switchers/ovhd/ark_2_hundr_right")) -- сотни частоты 1 - 17
defineProperty("ark_2_tens_right", globalPropertyi("sim/custom/switchers/ovhd/ark_2_tens_right")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_2_ones_right", globalPropertyi("sim/custom/switchers/ovhd/ark_2_ones_right")) -- единицы частоты 0 - 9

defineProperty("ark_2_ramka", globalPropertyi("sim/custom/buttons/ovhd/ark_2_ramka")) -- кнопка рамки
...
-- caps
defineProperty("bkk_contr_cap", globalPropertyi("sim/custom/switchers/ovhd/bkk_contr_cap"))  -- крышка тумблера контроля БКК
defineProperty("bkk_on_cap", globalPropertyi("sim/custom/switchers/ovhd/bkk_on_cap"))  -- крышка выключателя БКК
defineProperty("sau_stu_cap", globalPropertyi("sim/custom/switchers/ovhd/sau_stu_cap"))  -- крышка выключателя САУ СТУ
defineProperty("pkp_left_cap", globalPropertyi("sim/custom/switchers/ovhd/pkp_left_cap"))  -- крылка ПКП лев
defineProperty("pkp_right_cap", globalPropertyi("sim/custom/switchers/ovhd/pkp_right_cap"))  -- крышка ПКП прав
defineProperty("mgv_contr_cap", globalPropertyi("sim/custom/switchers/ovhd/mgv_contr_cap"))  -- 	контроль МГВ крышка
defineProperty("emerg_light_cap", globalPropertyi("sim/custom/switchers/ovhd/emerg_light_cap"))  -- крышка аварийного освещения

defineProperty("egpws_alarm_1_cap", globalPropertyi("sim/custom/switchers/ovhd/egpws_alarm_1_cap")) -- сигнализация СРПБЗ общ
defineProperty("egpws_alarm_2_cap", globalPropertyi("sim/custom/switchers/ovhd/egpws_alarm_2_cap")) -- сигнализация СРПБЗ 

-- lamps
defineProperty("heat_ok_1", globalPropertyf("sim/custom/lights/small/heat_ok_1")) -- лампа исправности обогрева ППД
defineProperty("heat_ok_2", globalPropertyf("sim/custom/lights/small/heat_ok_2")) -- лампа исправности обогрева ППД
defineProperty("heat_ok_3", globalPropertyf("sim/custom/lights/small/heat_ok_3")) -- лампа исправности обогрева ППД

defineProperty("tks_main_fail", globalPropertyf("sim/custom/lights/small/tks_main_fail")) -- отказ осн ГА на ТКС
defineProperty("tks_contr_fail", globalPropertyf("sim/custom/lights/small/tks_contr_fail")) -- отказ контр ГА на ТКС

defineProperty("bkk_ok", globalPropertyf("sim/custom/lights/small/bkk_ok")) -- лампа исправности БКК
