...
defineProperty("show_ground_panel",globalPropertyi("sim/custom/panels/show_ground_panel")) -- показать панель наземного обслуживания
...
--defineProperty("save_state_enabled",globalPropertyi("sim/custom/save_state_enabled")) -- включено ли сохранение состояния самолета
...
defineProperty("sounds_volume", globalPropertyi("sim/custom/sounds_voulme")) -- общая громкость звуков
...
defineProperty("ladder_1_call", globalPropertyi("sim/custom/anim/ladder_1_call")) -- трап. 100 - скрыт. +50..0 - подъезжает, 0 - стоит возле замолета, 0..-50 - уезжает
...
defineProperty("ladder_1", globalPropertyf("sim/custom/anim/ladder_1")) -- - скрыт. +50..0 - подъезжает, 0 - стоит возле замолета, 0..-50 - уезжает	100 
...
-- custom fails
defineProperty("pitot_fail1", globalPropertyi("sim/custom/failures/pitot1")) -- Pitot 1 - Blockage
defineProperty("pitot_fail2", globalPropertyi("sim/custom/failures/pitot2")) -- Pitot 2 - Blockage
