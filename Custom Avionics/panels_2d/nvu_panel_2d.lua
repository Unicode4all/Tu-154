...
defineProperty("show_nvu_panel",globalPropertyi("sim/custom/panels/show_nvu_panel")) -- показать панель НВУ
...
defineProperty("nav_course_1", globalPropertyf("sim/custom/rotary/console/nav_1_course")) -- ручка установки курса
defineProperty("nav_course_2", globalPropertyf("sim/custom/rotary/console/nav_2_course")) -- ручка установки курса
...
-- DISS
defineProperty("wind_set", globalPropertyf("sim/custom/rotary/console/wind_set")) -- установка ветра

defineProperty("wind_course_left", globalPropertyi("sim/custom/button/console/wind_course_left")) -- кнопка установки курса ветра 
defineProperty("wind_course_ctr", globalPropertyi("sim/custom/button/console/wind_course_ctr")) -- кнопка установки курса ветра 
defineProperty("wind_course_right", globalPropertyi("sim/custom/button/console/wind_course_right")) -- кнопка установки курса ветра 

defineProperty("wind_spd_left", globalPropertyi("sim/custom/button/console/wind_spd_left")) -- кнопка установки скорости ветра 
defineProperty("wind_spd_ctr", globalPropertyi("sim/custom/button/console/wind_spd_ctr")) -- кнопка установки скорости ветра 
defineProperty("wind_spd_right", globalPropertyi("sim/custom/button/console/wind_spd_right")) -- кнопка установки скорости ветра 

defineProperty("diss_wind_course", globalPropertyf("sim/custom/nvu/diss_wind_course")) -- курс ветра по ДИСС
defineProperty("diss_wind_spd", globalPropertyf("sim/custom/nvu/diss_wind_spd")) -- скорость ветра по ДИСС

defineProperty("diss_abs_angle_1", globalPropertyf("sim/custom/gauges/misc/diss_abs_angle_1")) -- барабанчик единиц угла
defineProperty("diss_abs_angle_10", globalPropertyf("sim/custom/gauges/misc/diss_abs_angle_10")) -- барабанчик единиц угла
defineProperty("diss_abs_angle_100", globalPropertyf("sim/custom/gauges/misc/diss_abs_angle_100")) -- барабанчик единиц угла
defineProperty("diss_plus_angle_1", globalPropertyf("sim/custom/gauges/misc/diss_plus_angle_1")) -- барабанчик единиц угла
defineProperty("diss_plus_angle_10", globalPropertyf("sim/custom/gauges/misc/diss_plus_angle_10")) -- барабанчик единиц угла
defineProperty("diss_minus_angle_1", globalPropertyf("sim/custom/gauges/misc/diss_minus_angle_1")) -- барабанчик единиц угла
defineProperty("diss_minus_angle_10", globalPropertyf("sim/custom/gauges/misc/diss_minus_angle_10")) -- барабанчик единиц угла
defineProperty("diss_wind_spd_1", globalPropertyf("sim/custom/gauges/misc/diss_wind_spd_1")) -- барабанчик единиц угла
defineProperty("diss_wind_spd_10", globalPropertyf("sim/custom/gauges/misc/diss_wind_spd_10")) -- барабанчик единиц угла
defineProperty("diss_wind_spd_100", globalPropertyf("sim/custom/gauges/misc/diss_wind_spd_100")) -- барабанчик единиц угла
