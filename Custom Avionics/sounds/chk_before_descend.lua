...
defineProperty("course_mk_1", globalPropertyf("sim/custom/tks/course_mk_1")) -- курс на MK5
defineProperty("course_mk_2", globalPropertyf("sim/custom/tks/course_mk_2")) -- курс на MK5
...
defineProperty("radioalt_dh_left", globalPropertyf("sim/custom/gauges/alt/radioalt_dh_left")) -- стрелка ВПР радиовысотомера КВС
