...
defineProperty("stu_mode", globalPropertyi("sim/custom/absu/stu_mode")) -- режимы автомата тяги 0 - выкл, 1 - вкл, 2 - готов, 3 стаб,
...
defineProperty("speaker_auasp", globalPropertyi("sim/custom/alarm/speaker_auasp")) -- предельный угол атаки или перегрузки
...
defineProperty("speaker_absu", globalPropertyi("sim/custom/alarm/speaker_absu")) -- отключение режимов или отказы АБСУ

defineProperty("fire_siren", globalPropertyi("sim/custom/fire/fire_siren")) -- работа сирены

-- controls
defineProperty("srd_buzzer", globalPropertyi("sim/custom/switchers/eng/srd_buzzer")) -- сирена СРД
defineProperty("fuel_buzzer", globalPropertyi("sim/custom/switchers/eng/fuel_buzzer")) -- сирена топл

defineProperty("srd_buzzer_cap", globalPropertyi("sim/custom/switchers/eng/srd_buzzer_cap")) -- сирена СРД
defineProperty("fuel_buzzer_cap", globalPropertyi("sim/custom/switchers/eng/fuel_buzzer_cap")) -- сирена СРД

defineProperty("srd_buzzer_test", globalPropertyi("sim/custom/buttons/eng/srd_buzzer_test")) -- кнопка проверки
...
-- lights
defineProperty("light_open_left", globalPropertyf("sim/custom/anim/light_open_left")) -- light open
defineProperty("light_open_right", globalPropertyf("sim/custom/anim/light_open_right")) -- light open
