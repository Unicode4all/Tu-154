...
defineProperty("vbe_pressure", globalPropertyf("sim/custom/gauges/alt/vbe_press_left"))  -- pressure in hPa
...
defineProperty("rv_flag_1", globalPropertyi("sim/custom/gauges/alt/radioalt_flag_left"))  -- RV flag
defineProperty("rv_flag_2", globalPropertyi("sim/custom/gauges/alt/radioalt_flag_right"))  -- RV flag
