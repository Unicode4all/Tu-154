...
defineProperty("side",globalPropertyi("sim/custom/checklist/side")) -- какую сторону показывать. 0 - пред взлетом, 1 - перед заходом

defineProperty("fishka_1",globalPropertyi("sim/custom/checklist/fishka_1")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_2",globalPropertyi("sim/custom/checklist/fishka_2")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_3",globalPropertyi("sim/custom/checklist/fishka_3")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_4",globalPropertyi("sim/custom/checklist/fishka_4")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_5",globalPropertyi("sim/custom/checklist/fishka_5")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_6",globalPropertyi("sim/custom/checklist/fishka_6")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_7",globalPropertyi("sim/custom/checklist/fishka_7")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_8",globalPropertyi("sim/custom/checklist/fishka_8")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_9",globalPropertyi("sim/custom/checklist/fishka_9")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_10",globalPropertyi("sim/custom/checklist/fishka_10")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_11",globalPropertyi("sim/custom/checklist/fishka_11")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_12",globalPropertyi("sim/custom/checklist/fishka_12")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_13",globalPropertyi("sim/custom/checklist/fishka_13")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_14",globalPropertyi("sim/custom/checklist/fishka_14")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_15",globalPropertyi("sim/custom/checklist/fishka_15")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_16",globalPropertyi("sim/custom/checklist/fishka_16")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_17",globalPropertyi("sim/custom/checklist/fishka_17")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_18",globalPropertyi("sim/custom/checklist/fishka_18")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_19",globalPropertyi("sim/custom/checklist/fishka_19")) -- положение фишки. 0 - слева, 1 - справа
defineProperty("fishka_20",globalPropertyi("sim/custom/checklist/fishka_20")) -- положение фишки. 0 - слева, 1 - справа

defineProperty("checklist_selected",globalPropertyi("sim/custom/checklist/checklist_selected")) -- выбор чеклиста
...
defineProperty("sard_cabin_press_set", globalPropertyf("sim/custom/switchers/sard/sard_cabin_press_set")) -- установка давления в кабине
...
defineProperty("ark15_L_cc", globalPropertyf("sim/custom/radio/ark15_L_cc")) -- потребление тока АРК
defineProperty("ark15_R_cc", globalPropertyf("sim/custom/radio/ark15_R_cc")) -- потребление тока АРК
...
defineProperty("pkp_fail_left", globalPropertyi("sim/custom/bkk/pkp_fail_left")) -- сигнал с БКК - отказ левого ПКП
defineProperty("pkp_fail_right", globalPropertyi("sim/custom/bkk/pkp_fail_right")) -- сигнал с БКК - отказ левого ПКП	
defineProperty("pitch_corr_hdl_1", globalPropertyf("sim/custom/gauges/ahz/pitch_corr_L")) -- коррекция тангажа на АГР + вправо
defineProperty("pitch_corr_hdl_2", globalPropertyf("sim/custom/gauges/ahz/pitch_corr_R")) -- коррекция тангажа на АГР + вправо

defineProperty("course_ga_1", globalPropertyf("sim/custom/tks/course_ga_1")) -- курс на ГА1
defineProperty("course_ga_2", globalPropertyf("sim/custom/tks/course_ga_2")) -- курс на ГА2
defineProperty("course_bgmk_1", globalPropertyf("sim/custom/tks/course_bgmk_1")) -- курс на БГМК1
defineProperty("course_bgmk_2", globalPropertyf("sim/custom/tks/course_bgmk_2")) -- курс на БГМК2
