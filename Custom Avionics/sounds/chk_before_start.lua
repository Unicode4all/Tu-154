...
defineProperty("door1", globalPropertyf("sim/custom/lights/left_front_pax_door")) -- левая передняя дверь открыта
defineProperty("door2", globalPropertyf("sim/custom/lights/left_mid_pax_door")) -- левая средняя дверь открыта
defineProperty("door3", globalPropertyf("sim/custom/lights/right_mid_pax_door")) -- средняя средняя дверь открыта
defineProperty("door4", globalPropertyf("sim/custom/lights/cargo_front_door")) -- передний багажный люк
defineProperty("door5", globalPropertyf("sim/custom/lights/cargo_back_door")) -- задний багажный люк
...
defineProperty("cg_pos_actual", globalPropertyf("sim/custom/misc/cg_pos_actual")) -- актуальное положение CG
defineProperty("weight_actual", globalPropertyf("sim/custom/misc/weight_actual")) -- актуальная масса
