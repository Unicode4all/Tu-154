...
defineProperty("nav_pow_cc", globalPropertyf("sim/custom/radio/nav1_pow_cc")) -- потребление тока от КурсМП

defineProperty("obs", globalPropertyf("sim/custom/gauges/compas/pkp_obs_set_L"))  -- set the course

defineProperty("ark15_cc_1", globalPropertyf("sim/custom/radio/ark15_L_cc")) -- потребление тока АРК
defineProperty("ark15_cc_2", globalPropertyf("sim/custom/radio/ark15_R_cc")) -- потребление тока АРК
