defineProperty("reset_crew", globalPropertyi("sim/custom/sound/reset_crew")) -- сброс фраз команды
...
defineProperty("parking_brake", globalPropertyi("sim/custom/controll/parking_brake")) -- ручка фиксации тормоза
...
defineProperty("turn_rate_ind", globalPropertyf("sim/custom/gauges/misc/turn_rate_ind")) -- индикатор разворота
defineProperty("big_course_needle", globalPropertyf("sim/custom/gauges/compas/big_course_needle")) -- стрелка "самолетик"

-- flaps and stab


defineProperty("stab_man_cap", globalPropertyi("sim/custom/controll/stab_man_cap")) -- положение крышки управления стабилизатором
...
defineProperty("engine_caps", globalPropertyi("sim/custom/anim/engine_caps")) -- установка крышек двигателей
defineProperty("gear_blocks", globalPropertyi("sim/custom/anim/gear_blocks")) -- установка блоков шасси
defineProperty("sensors_caps", globalPropertyi("sim/custom/anim/sensors_caps")) -- установка крышек датчиков
...
defineProperty("alt_mtr", globalPropertyf("sim/custom/gauges/alt/vbe_alt_left"))  -- indicated altitude in meters

defineProperty("dh_set", globalPropertyf("sim/custom/gauges/alt/radioalt_dh_left"))  -- DH angle
defineProperty("rv_test_btn", globalPropertyf("sim/custom/gauges/alt/radioalt_button_left"))  -- Test button
defineProperty("rv_angle", globalPropertyf("sim/custom/gauges/alt/radioalt_needle_left"))  -- RV needle

defineProperty("rv_lamp", globalPropertyf("sim/custom/lights/small/rv5_left_dh"))  -- RV lamp
...
-- lights
defineProperty("landing_ext_set_L", globalPropertyi("sim/custom/lights/landing_ext_set_L")) -- выпуск фар лев
defineProperty("landing_ext_set_R", globalPropertyi("sim/custom/lights/landing_ext_set_R")) -- выпуск фар прав
defineProperty("landing_mode_set_L", globalPropertyi("sim/custom/lights/landing_mode_set_L")) -- режим фар лев. -1 - рулежный, 0 - выкл, +1 - посадочный
defineProperty("landing_mode_set_R", globalPropertyi("sim/custom/lights/landing_mode_set_R")) -- режим фар прав
