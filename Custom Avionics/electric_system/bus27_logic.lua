...
-- sources
defineProperty("bat_volt_1", globalPropertyf("sim/custom/elec/bat_volt_1")) -- напряжение батареи
defineProperty("bat_volt_2", globalPropertyf("sim/custom/elec/bat_volt_2")) -- напряжение батареи
defineProperty("bat_volt_3", globalPropertyf("sim/custom/elec/bat_volt_3")) -- напряжение батареи
defineProperty("bat_volt_4", globalPropertyf("sim/custom/elec/bat_volt_4")) -- напряжение батареи

defineProperty("bat_amp_1", globalPropertyf("sim/custom/elec/bat_amp_1")) -- ток батареи
defineProperty("bat_amp_2", globalPropertyf("sim/custom/elec/bat_amp_2")) -- ток батареи
defineProperty("bat_amp_3", globalPropertyf("sim/custom/elec/bat_amp_3")) -- ток батареи
defineProperty("bat_amp_4", globalPropertyf("sim/custom/elec/bat_amp_4")) -- ток батареи

defineProperty("bat_1_kz", globalPropertyi("sim/custom/failures/bat_1_kz")) -- тепловой разгон
defineProperty("bat_2_kz", globalPropertyi("sim/custom/failures/bat_2_kz")) -- тепловой разгон
defineProperty("bat_3_kz", globalPropertyi("sim/custom/failures/bat_3_kz")) -- тепловой разгон
defineProperty("bat_4_kz", globalPropertyi("sim/custom/failures/bat_4_kz")) -- тепловой разгон

defineProperty("bat_fail_1", globalPropertyi("sim/custom/failures/bat_1_fail")) -- отказ батареи
defineProperty("bat_fail_2", globalPropertyi("sim/custom/failures/bat_2_fail")) -- отказ батареи
defineProperty("bat_fail_3", globalPropertyi("sim/custom/failures/bat_3_fail")) -- отказ батареи
defineProperty("bat_fail_4", globalPropertyi("sim/custom/failures/bat_4_fail")) -- отказ батареи

defineProperty("bat_source_1", globalPropertyi("sim/custom/elec/bat_is_source_1")) -- батарея является источником
defineProperty("bat_source_2", globalPropertyi("sim/custom/elec/bat_is_source_2")) -- батарея является источником
defineProperty("bat_source_3", globalPropertyi("sim/custom/elec/bat_is_source_3")) -- батарея является источником
defineProperty("bat_source_4", globalPropertyi("sim/custom/elec/bat_is_source_4")) -- батарея является источником
...
defineProperty("vu1_volt", globalPropertyf("sim/custom/elec/vu1_volt")) -- работа ВУ
defineProperty("vu2_volt", globalPropertyf("sim/custom/elec/vu2_volt")) -- работа ВУ
defineProperty("vu_res_volt", globalPropertyf("sim/custom/elec/vu_res_volt")) -- работа ВУ
...
defineProperty("vu1_fail", globalPropertyi("sim/custom/failures/vu1_fail")) -- отказ ВУ
defineProperty("vu2_fail", globalPropertyi("sim/custom/failures/vu2_fail")) -- отказ ВУ
defineProperty("vu3_fail", globalPropertyi("sim/custom/failures/vu3_fail")) -- отказ ВУ
