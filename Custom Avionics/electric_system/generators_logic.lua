...
-- gen parameters
defineProperty("gen1_volt_bus", globalPropertyf("sim/custom/elec/gen1_volt"))  -- generator voltage, initial 115
...
defineProperty("gen1_amp_bus", globalPropertyf("sim/custom/elec/gen1_amp")) -- generator current load from bus, initial 0A
...
defineProperty("gen1_overload", globalPropertyf("sim/custom/elec/gen1_overload")) -- 140A maximum
...
defineProperty("gpu_on_sw", globalPropertyi("sim/custom/switchers/eng/gpu_on")) -- выключатель РАП

defineProperty("gen1_work", globalPropertyf("sim/custom/elec/gen1_work"))  -- generators connected to the busses and working
...
-- bus 27v
defineProperty("DC_27_volt1", globalPropertyf("sim/custom/elec/bus27_volt_left")) -- 27 volt
defineProperty("DC_27_volt2", globalPropertyf("sim/custom/elec/bus27_volt_right")) -- 27 volt
...
defineProperty("eng4_N1", globalPropertyf("sim/custom/eng/apu_n1")) -- обороты ВСУ
