...
-- controls on panel
defineProperty("gpu_on", globalPropertyi("sim/custom/switchers/eng/gpu_on")) -- выключатель РАП
defineProperty("apu_gen_on", globalPropertyi("sim/custom/switchers/eng/apu_gen_on")) -- выключатель ген ВСУ
defineProperty("bus115_volt_sel", globalPropertyi("sim/custom/switchers/eng/bus115_volt_sel")) -- переключатель источника вольтметра
defineProperty("bus115_volt_phase_sel", globalPropertyi("sim/custom/switchers/eng/bus115_volt_phase_sel")) -- переключатель источника вольтметра
defineProperty("bus115_amp_sel", globalPropertyi("sim/custom/switchers/eng/bus115_amp_sel")) -- переключатель источника амерметра
defineProperty("bus115_amp_phase_sel", globalPropertyi("sim/custom/switchers/eng/bus115_amp_phase_sel")) -- переключатель источника амерметра

defineProperty("gen_1_on", globalPropertyi("sim/custom/switchers/eng/gen_1_on")) -- выключатель генератора 1. -1 - проверка, 0 - выкл, +1 - вкл
defineProperty("gen_2_on", globalPropertyi("sim/custom/switchers/eng/gen_2_on")) -- выключатель генератора 1. -1 - проверка, 0 - выкл, +1 - вкл
defineProperty("gen_3_on", globalPropertyi("sim/custom/switchers/eng/gen_3_on")) -- выключатель генератора 1. -1 - проверка, 0 - выкл, +1 - вкл

defineProperty("emerg_inv115", globalPropertyi("sim/custom/switchers/eng/emerg_inv115")) -- аварийн. преобраз 115в
defineProperty("emerg_inv115_cap", globalPropertyi("sim/custom/switchers/eng/emerg_inv115_cap")) -- аварийн. преобраз 115в

defineProperty("bus36_volt_sel", globalPropertyi("sim/custom/switchers/eng/bus36_volt_sel")) -- переключатель вольтметра 36в
defineProperty("pts250_sel", globalPropertyi("sim/custom/switchers/eng/pts250_sel")) -- переключатель ПТС250. 0 - №1, 1 - №2
defineProperty("bus36_tr_left_to_right", globalPropertyi("sim/custom/switchers/eng/bus36_tr_left_to_right")) -- лев сеть на тр2. 0 - авто, 1 - ручное
defineProperty("bus36_tr_right_to_left", globalPropertyi("sim/custom/switchers/eng/bus36_tr_right_to_left")) -- прав сеть на тр1
defineProperty("pts250_on", globalPropertyi("sim/custom/switchers/eng/pts250_on")) -- выключатель ПТС250
defineProperty("pts250_mode", globalPropertyi("sim/custom/switchers/eng/pts250_mode")) -- режим ПТС250. авто - ручное
defineProperty("pts250_on_cap", globalPropertyi("sim/custom/switchers/eng/pts250_on_cap")) -- выключатель ПТС250
defineProperty("pts250_mode_cap", globalPropertyi("sim/custom/switchers/eng/pts250_mode_cap")) -- режим ПТС250. авто - ручное

defineProperty("bus27_volt_sel", globalPropertyi("sim/custom/switchers/eng/bus27_volt_sel")) -- переключатель вольтметра 27в
defineProperty("bus27_amp1_sel", globalPropertyi("sim/custom/switchers/eng/bus27_amp1_sel")) -- переключатель амперметра 27в
defineProperty("bus27_amp2_sel", globalPropertyi("sim/custom/switchers/eng/bus27_amp2_sel")) -- переключатель амперметра 27в

defineProperty("bus27_connect", globalPropertyi("sim/custom/switchers/eng/bus27_connect")) -- соединение сетей 27в
defineProperty("bus27_connect_cap", globalPropertyi("sim/custom/switchers/eng/bus27_connect_cap")) -- соединение сетей 27в
defineProperty("bus27_vu1", globalPropertyi("sim/custom/switchers/eng/bus27_vu1")) -- ВУ1. -1 - резерв, 0 - выкл, +1 - вкл.
defineProperty("bus27_vu2", globalPropertyi("sim/custom/switchers/eng/bus27_vu2")) -- ВУ2. -1 - резерв, 0 - выкл, +1 - вкл.
defineProperty("bat1_on", globalPropertyi("sim/custom/switchers/eng/bat1_on")) -- батарея 1
defineProperty("bat2_on", globalPropertyi("sim/custom/switchers/eng/bat2_on")) -- батарея 2
defineProperty("bat3_on", globalPropertyi("sim/custom/switchers/eng/bat3_on")) -- батарея 3
defineProperty("bat4_on", globalPropertyi("sim/custom/switchers/eng/bat4_on")) -- батарея 4

-- gauges
defineProperty("bus115_freq", globalPropertyf("sim/custom/gauges/eng/bus115_freq")) -- частотомер сети 115в - угол
defineProperty("bus115_volt", globalPropertyf("sim/custom/gauges/eng/bus115_volt")) -- вольтметр сети 115в - угол
defineProperty("bus115_amp", globalPropertyf("sim/custom/gauges/eng/bus115_amp")) -- амерметр сети 115в - угол

defineProperty("bus36_volt", globalPropertyf("sim/custom/gauges/eng/bus36_volt")) -- вольтметр сети 36в - угол

defineProperty("bus27_volt", globalPropertyf("sim/custom/gauges/eng/bus27_volt")) -- вольтметр сети 36в - угол
defineProperty("bus27_amp1", globalPropertyf("sim/custom/gauges/eng/bus27_amp1")) -- вольтметр сети 36в - угол
defineProperty("bus27_amp2", globalPropertyf("sim/custom/gauges/eng/bus27_amp2")) -- вольтметр сети 36в - угол
...
defineProperty("bat_amp_cc_1", globalPropertyf("sim/custom/elec/bat_cc_1")) -- ток заряда батареи
defineProperty("bat_amp_cc_2", globalPropertyf("sim/custom/elec/bat_cc_2")) -- ток заряда батареи
defineProperty("bat_amp_cc_3", globalPropertyf("sim/custom/elec/bat_cc_3")) -- ток заряда батареи
defineProperty("bat_amp_cc_4", globalPropertyf("sim/custom/elec/bat_cc_4")) -- ток заряда батареи
...
-- lamps
defineProperty("lamp_apu_gen_on", globalPropertyf("sim/custom/lights/small/apu_gen_on")) -- РАП подключен
defineProperty("bus_npk_1", globalPropertyf("sim/custom/lights/small/bus_npk_1")) -- сети НПК лев на 3
defineProperty("bus_npk_2", globalPropertyf("sim/custom/lights/small/bus_npk_2")) -- сети НПК прав на 1
defineProperty("emerg_inv_115", globalPropertyf("sim/custom/lights/small/emerg_inv_115")) -- аварийный преобразов. 115в

defineProperty("gen_fail_1", globalPropertyf("sim/custom/lights/small/gen_fail_1")) -- генератор не работает
defineProperty("gen_fail_2", globalPropertyf("sim/custom/lights/small/gen_fail_2")) -- генератор не работает
defineProperty("gen_fail_3", globalPropertyf("sim/custom/lights/small/gen_fail_3")) -- генератор не работает

defineProperty("bus_connected", globalPropertyf("sim/custom/lights/small/bus_connected")) -- сети соединены
defineProperty("left_bus_use_bat", globalPropertyf("sim/custom/lights/small/left_bus_use_bat")) -- левая сеть от батарей
defineProperty("right_bus_use_bat", globalPropertyf("sim/custom/lights/small/right_bus_use_bat")) -- правая сеть от батарей

defineProperty("turn_off_bat_1", globalPropertyf("sim/custom/lights/small/turn_off_bat_1")) -- выключи батарею
defineProperty("turn_off_bat_3", globalPropertyf("sim/custom/lights/small/turn_off_bat_3")) -- выключи батарею
defineProperty("turn_off_bat_2", globalPropertyf("sim/custom/lights/small/turn_off_bat_2")) -- выключи батарею
defineProperty("turn_off_bat_4", globalPropertyf("sim/custom/lights/small/turn_off_bat_4")) -- выключи батарею

defineProperty("vu_on_1", globalPropertyf("sim/custom/lights/small/vu_on_1")) -- ВУ1
defineProperty("vu_on_2", globalPropertyf("sim/custom/lights/small/vu_on_2")) -- ВУ2
defineProperty("left_bus_on_tr2", globalPropertyf("sim/custom/lights/small/left_bus_on_tr2")) -- левая сеть на тр 2
defineProperty("right_bus_on_tr1", globalPropertyf("sim/custom/lights/small/right_bus_on_tr1")) -- правая сеть на тр 1
defineProperty("pts250_n1", globalPropertyf("sim/custom/lights/small/pts250_n1")) -- ПТС 250 не работает
defineProperty("pts250_n2", globalPropertyf("sim/custom/lights/small/pts250_n2")) -- ПТС 250 на сеть

-- lamps sources
defineProperty("test_lamps", globalPropertyi("sim/custom/buttons/lamp_test_apu")) -- кнопка првоерки ламп панели ВСУ
...
defineProperty("bus27_source_left", globalPropertyf("sim/custom/elec/bus27_source_left")) -- источник сети. 0 - ничего. 1 - ВУ1, 2 - ВУрезерв, 3 - батареи 1 и 3, 6 - соседняя сеть
defineProperty("bus27_source_right", globalPropertyf("sim/custom/elec/bus27_source_right")) -- источник сети. 0 - ничего. 1 - ВУ2, 2 - ВУрезерв, 3 - батареи 2 и 4, 6 - соседняя сеть

defineProperty("vu_res_to_L", globalPropertyi("sim/custom/elec/vu_res_to_L")) -- резервное ВУ подключено на лев сеть
defineProperty("vu_res_to_R", globalPropertyi("sim/custom/elec/vu_res_to_R")) -- резервное ВУ подключено на прав сеть

defineProperty("bus36_src_L", globalPropertyi("sim/custom/elec/bus36_src_L")) --  источник левой сети. 0 = ТР1, 1 = ТР2
defineProperty("bus36_src_R", globalPropertyi("sim/custom/elec/bus36_src_R")) -- источник правой сети. 0 = ТР2, 1 = ТР1

defineProperty("bus36_pts1_work", globalPropertyi("sim/custom/elec/bus36_pts1_work")) -- ПТС250 1 работает
defineProperty("bus36_pts2_work", globalPropertyi("sim/custom/elec/bus36_pts2_work")) -- ПТС250 2 работает

defineProperty("bat_therm_1", globalPropertyf("sim/custom/elec/bat_therm_1")) -- температурыа батаре
defineProperty("bat_therm_2", globalPropertyf("sim/custom/elec/bat_therm_2")) -- температурыа батаре
defineProperty("bat_therm_3", globalPropertyf("sim/custom/elec/bat_therm_3")) -- температурыа батаре
defineProperty("bat_therm_4", globalPropertyf("sim/custom/elec/bat_therm_4")) -- температурыа батаре
