...
-- source
defineProperty("bat_on_bus", globalPropertyi("sim/custom/switchers/eng/bat1_on")) -- батарея подключена в сеть
defineProperty("bat_source", globalPropertyi("sim/custom/elec/bat_is_source_1")) -- батарея является источником
defineProperty("bat_amp_bus", globalPropertyf("sim/custom/elec/bat_amp_1")) -- нагрузка батареи
defineProperty("bat_amp_cc", globalPropertyf("sim/custom/elec/bat_cc_1")) -- ток заряда батареи
defineProperty("bat_volt_bus", globalPropertyf("sim/custom/elec/bat_volt_1")) -- напряжение батареи
defineProperty("bat_thermo", globalPropertyf("sim/custom/elec/bat_therm_1")) -- напряжение батареи

defineProperty("bat_fail", globalPropertyi("sim/custom/failures/bat_1_fail")) -- отказ батареи
defineProperty("bat_kz", globalPropertyi("sim/custom/failures/bat_1_kz")) -- тепловой разгон

defineProperty("bus_volt", globalPropertyf("sim/custom/elec/bus27_volt_left")) -- напряжение в сети.

defineProperty("cockpit_temp", globalPropertyf("sim/custom/thermo/cockpit_temp")) -- температура в кабине
