...
-- power
defineProperty("bus27_volt", globalPropertyf("sim/custom/elec/bus27_volt_left")) -- напряжение сети 27
defineProperty("bus115_volt", globalPropertyf("sim/custom/elec/bus115_1_volt")) -- напряжение на сети 115в
...
defineProperty("diss_mode_set", globalPropertyi("sim/custom/nvu/diss_mode")) -- режим ДИСС. 0 - выкл, 1 - работа, 2 - память, 10 - отказ
...
-- lamps
defineProperty("diss_memory", globalPropertyf("sim/custom/lights/diss_memory")) -- память ДИСС
