...
defineProperty("uvid_needle_left", globalPropertyf("sim/custom/gauges/alt/uvid_needle_left"))  -- стрелка высотомера УВИД КВС
defineProperty("uvid_feet_counter", globalPropertyf("sim/custom/gauges/alt/uvid_feet_counter"))  -- барабанчик счета удиниц футов
defineProperty("uvid_hundreads_counter", globalPropertyf("sim/custom/gauges/alt/uvid_hundreads_counter"))  -- барабанчик счета сотен футов
defineProperty("uvid_thousands_counter", globalPropertyf("sim/custom/gauges/alt/uvid_thousands_counter"))  -- барабанчик счета тысяч футов
defineProperty("uvid_tens_thousands_counter", globalPropertyf("sim/custom/gauges/alt/uvid_tens_thousands_counter"))  -- барабанчик счета десятков тысяч футов
defineProperty("uvid_pressure_knob", globalPropertyf("sim/custom/gauges/alt/uvid_pressure_knob"))  -- ручка установки давления
defineProperty("uvid_pressure_one", globalPropertyf("sim/custom/gauges/alt/uvid_pressure_one"))  -- единицы давления
defineProperty("uvid_pressure_ten", globalPropertyf("sim/custom/gauges/alt/uvid_pressure_ten"))  -- десятки давления
defineProperty("uvid_pressure_hund", globalPropertyf("sim/custom/gauges/alt/uvid_pressure_hund"))  -- сотни давления
defineProperty("uvid_pressure_thous", globalPropertyf("sim/custom/gauges/alt/uvid_pressure_thous"))  -- тысячи давления
...
defineProperty("vd15_lamp", globalPropertyf("sim/custom/lights/small/vd15_lamp"))  -- лампочка УВИД15
