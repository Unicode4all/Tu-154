...
-- caps
defineProperty("sensors_caps", globalPropertyi("sim/custom/anim/sensors_caps"))  -- чехлы и крышки


-- gauges
defineProperty("kus_ias_left", globalPropertyf("sim/custom/gauges/speed/kus_ias_left")) -- приборная скорость на КУС730 КВС
defineProperty("kus_tas_left", globalPropertyf("sim/custom/gauges/speed/kus_tas_left")) -- истинная скорость на КУС730 КВС

defineProperty("kus_ias_right", globalPropertyf("sim/custom/gauges/speed/kus_ias_right")) -- приборная скорость на КУС730 2П
defineProperty("kus_tas_right", globalPropertyf("sim/custom/gauges/speed/kus_tas_right")) -- истинная скорость на КУС730 2П

defineProperty("kus_ias_eng", globalPropertyf("sim/custom/gauges/speed/kus_ias_eng")) -- приборная скорость на КУС730 БИ
defineProperty("kus_tas_eng", globalPropertyf("sim/custom/gauges/speed/kus_tas_eng")) -- истинная скорость на КУС730 БИ
...
defineProperty("var75", globalPropertyf("sim/custom/gauges/alt/var75")) -- выриометр 75 КВС
defineProperty("var30", globalPropertyf("sim/custom/gauges/alt/var30")) -- выриометр 30 БИ

defineProperty("var30_cabin", globalPropertyf("sim/custom/gauges/airbleed/cabin_vvi")) -- выриометр кабинный
defineProperty("cabin_diff", globalPropertyf("sim/custom/gauges/airbleed/cabin_diff")) -- перепад давления
defineProperty("cabin_alt", globalPropertyf("sim/custom/gauges/airbleed/cabin_alt")) -- высота в кабине

-- altimeters
defineProperty("vd15_alt_left", globalPropertyf("sim/custom/gauges/alt/vd15_alt_left")) -- высота на ВД15 КВС
defineProperty("vd15_tri_needle_left", globalPropertyf("sim/custom/gauges/alt/vd15_tri_needle_left")) -- стрелка коррекции на ВД15 КВС
defineProperty("vd15_pressure_left", globalPropertyf("sim/custom/gauges/alt/vd15_pressure_left")) -- давление на ВД15 КВС

defineProperty("vd15_alt_right", globalPropertyf("sim/custom/gauges/alt/vd15_alt_right")) -- высота на ВД15 2П
defineProperty("vd15_tri_needle_right", globalPropertyf("sim/custom/gauges/alt/vd15_tri_needle_right")) -- стрелка коррекции на ВД15 2П
defineProperty("vd15_pressure_right", globalPropertyf("sim/custom/gauges/alt/vd15_pressure_right")) -- давление на ВД15 2П

defineProperty("vd15_alt_eng", globalPropertyf("sim/custom/gauges/alt/vd15_alt_eng")) -- высота на ВД15 БИ
defineProperty("vd15_tri_needle_eng", globalPropertyf("sim/custom/gauges/alt/vd15_tri_needle_eng")) -- стрелка коррекции на ВД15 БИ
