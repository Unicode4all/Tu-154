...
-- lamps
defineProperty("tks_mode_lit_mk", globalPropertyf("sim/custom/lights/tks_mode_lit_mk")) -- лампочка режима ТКС - МК
defineProperty("tks_mode_lit_ak", globalPropertyf("sim/custom/lights/tks_mode_lit_ak")) -- лампочка режима ТКС - АК
defineProperty("tks_mode_lit_gpk", globalPropertyf("sim/custom/lights/tks_mode_lit_gpk")) -- лампочка режима ТКС - ГПК


-- results
defineProperty("big_course_needle", globalPropertyf("sim/custom/gauges/compas/big_course_needle")) -- стрелка "самолетик"
defineProperty("big_true_course_needle", globalPropertyf("sim/custom/gauges/compas/big_true_course_needle")) -- стрелка ПУ
defineProperty("big_tri_needle", globalPropertyf("sim/custom/gauges/compas/big_tri_needle")) -- треугольная стрелка
