...
defineProperty("course_mk", globalPropertyf("sim/custom/tks/course_mk_1")) -- курс на MK5
...
defineProperty("tks_on_1", globalPropertyi("sim/custom/switchers/ovhd/tks_on_1")) -- выключатель ТКС 
defineProperty("tks_on_2", globalPropertyi("sim/custom/switchers/ovhd/tks_on_2")) -- выключатель ТКС 
defineProperty("tks_heat", globalPropertyi("sim/custom/switchers/ovhd/tks_heat")) -- обогрев ГА
defineProperty("tks_corr_1", globalPropertyi("sim/custom/switchers/ovhd/tks_corr_1")) -- коррекция БГМК 2
defineProperty("tks_corr_2", globalPropertyi("sim/custom/switchers/ovhd/tks_corr_2")) -- коррекция БГМК 2
...
defineProperty("ga_1_cc", globalPropertyf("sim/custom/tks/ga_1_cc")) -- потребление тока
defineProperty("ga_2_cc", globalPropertyf("sim/custom/tks/ga_2_cc")) -- потребление тока
