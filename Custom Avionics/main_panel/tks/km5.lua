...
defineProperty("bus36_volt", globalPropertyf("sim/custom/elec/bus36_volt_pts250_2")) -- напряжение сети 36

-- failures
defineProperty("fail", globalPropertyf("sim/custom/failures/tks_km1_fail")) -- отказ

-- controls
defineProperty("km5_knob", globalPropertyf("sim/custom/gauges/eng/km5_knob_1")) -- крутилка на КМ5


-- results
defineProperty("km5_scale", globalPropertyf("sim/custom/gauges/eng/km5_scale_1")) -- поворот шкалы на КМ5
defineProperty("km5_needle", globalPropertyf("sim/custom/gauges/eng/km5_needle_1")) -- стрелка КМ5

defineProperty("course_mk", globalPropertyf("sim/custom/tks/course_mk_1")) -- курс на MK5

defineProperty("km5_cc", globalPropertyf("sim/custom/tks/km5_1_cc")) -- потребление тока КМ5
