...
-- fails
defineProperty("fail1", globalPropertyi("sim/custom/failures/tks_bgmk1_fail")) -- отказ
defineProperty("fail2", globalPropertyi("sim/custom/failures/tks_bgmk2_fail")) -- отказ
