...
defineProperty("ZK_select", globalPropertyi("sim/custom/switchers/ZK_select")) -- тумблер "ввод ЗК" на передней панели. 0-лев, 1-прав	0

defineProperty("absu_smooth_on", globalPropertyi("sim/custom/switchers/console/absu_smooth_on")) -- тумблер "вкл в болтанку"
...
defineProperty("nav_select", globalPropertyi("sim/custom/switchers/nav_select")) -- тумблер НВУ-СНС 0 - НВУ, 1 - СНС
...
-- PNP
defineProperty("pkp_course_L", globalPropertyf("sim/custom/gauges/compas/pkp_helper_course_L")) -- устанвока курса желтой стрелкой на ПКП
defineProperty("pkp_course_R", globalPropertyf("sim/custom/gauges/compas/pkp_helper_course_R")) -- устанвока курса желтой стрелкой на ПКП

defineProperty("pkp_gyro_course_L", globalPropertyf("sim/custom/gauges/compas/pkp_gyro_course_L")) -- курс гироскопа ПКП
defineProperty("pkp_gyro_course_R", globalPropertyf("sim/custom/gauges/compas/pkp_gyro_course_R")) -- курс гироскопа ПКП


defineProperty("pkp_obs_1", globalPropertyf("sim/custom/gauges/compas/pkp_obs_L")) -- курс полета на ПКП
defineProperty("pkp_obs_2", globalPropertyf("sim/custom/gauges/compas/pkp_obs_R")) -- курс полета на ПКП
-- angular speeds
...
-- SVS
defineProperty("mach_svs", globalPropertyf("sim/custom/svs/machno")) -- Mach number
defineProperty("alt_svs", globalPropertyf("sim/custom/svs/altitude")) -- Altitude by 1013 hpa
defineProperty("tas_svs", globalPropertyf("sim/custom/svs/true_airspeed")) -- TAS

defineProperty("ias", globalPropertyf("sim/cockpit2/gauges/indicators/airspeed_kts_pilot")) -- indicated airspeed in KTS

-- NVU
defineProperty("nvu_res_course", globalPropertyf("sim/custom/nvu/nvu_res_course")) -- курс полета по НВУ
defineProperty("nvu_res_z", globalPropertyf("sim/custom/nvu/nvu_res_z")) -- смещение от курса полета НВУ
...
-- БКК
defineProperty("bkk_pitch", globalPropertyf("sim/custom/bkk/bkk_pitch")) -- результирующий тангаж от БКК
defineProperty("bkk_roll", globalPropertyf("sim/custom/bkk/bkk_roll")) -- результирующий тангаж от БКК

-- TKS
defineProperty("course_gpk", globalPropertyf("sim/custom/tks/course_gpk")) -- результирующий курс ТКС - ГПК
defineProperty("course_gmk", globalPropertyf("sim/custom/tks/course_gmk")) -- результирующий курс ТКС - ГМК
...
-- DISS
defineProperty("diss_groundspeed", globalPropertyf("sim/custom/nvu/diss_groundspeed")) -- путевая скорость по ДИСС
defineProperty("diss_slip_angle", globalPropertyf("sim/custom/nvu/diss_slip_angle")) -- угол сноса по ДИСС
...
defineProperty("nav_cs_1", globalPropertyf("sim/custom/radio/nav1_cs")) -- course plank
defineProperty("nav_cs_2", globalPropertyf("sim/custom/radio/nav2_cs")) -- course plank
defineProperty("nav_gs_1", globalPropertyf("sim/custom/radio/nav1_gs")) -- glideslope
defineProperty("nav_gs_2", globalPropertyf("sim/custom/radio/nav2_gs")) -- glideslope
...
-- GNS
defineProperty("GNS430_dtk", globalPropertyf("sim/custom/SC/GNS430_dtk")) -- курс на ГНС
defineProperty("GNS430_dev", globalPropertyf("sim/custom/SC/GNS430_dev")) -- отклонение от курса на ГНС
...
defineProperty("dh_set", globalPropertyf("sim/custom/gauges/alt/radioalt_dh_left"))  -- DH angle
defineProperty("rv_angle", globalPropertyf("sim/custom/gauges/alt/radioalt_needle_left"))  -- RV needle
...
-- results
defineProperty("absu_roll_ind", globalPropertyf("sim/custom/absu/absu_roll_ind")) -- индикация директора крена
defineProperty("absu_pitch_ind", globalPropertyf("sim/custom/absu/absu_pitch_ind")) -- индикация директора тангажа

defineProperty("absu_roll_flag", globalPropertyi("sim/custom/absu/absu_roll_flag")) --	флаг директора крена
defineProperty("absu_pitch_flag", globalPropertyi("sim/custom/absu/absu_pitch_flag")) -- флаг директора тангажа
