...
defineProperty("absu_pitch_wheel", globalPropertyi("sim/custom/switchers/console/absu_pitch_wheel")) -- колесико спуска, подъема
...
defineProperty("absu_power_cc", globalPropertyf("sim/custom/absu_power_cc")) -- потребление тока АБСУ
...
defineProperty("nav_gs_1", globalPropertyf("sim/custom/radio/nav1_gs")) -- glideslope
...
defineProperty("rv5_alt", globalPropertyf("sim/custom/misc/rv5_alt_left"))  -- высота на левом высотомере
defineProperty("rv_flag", globalPropertyi("sim/custom/gauges/alt/radioalt_flag_left"))  -- RV flag
...
defineProperty("roll_sub_mode", globalPropertyi("sim/custom/absu/roll_sub_mode")) -- режим АБСУ по крену. 0 - выкл, 1 - стаб, 2 - ЗК, 3 - НВУ, 4 - АЗ1, 5 - АЗ2, 6 - заход, 7 - уход, 10 арм заход
defineProperty("pitch_sub_mode", globalPropertyi("sim/custom/absu/pitch_sub_mode")) -- режим АБСУ по тангажу. 0 - выкл, 1 - стаб, 2 - V, 3 - M, 4 - H, 5 - глисс, 6 - уход, 10 - арм глисс
...
defineProperty("toga_command", globalPropertyi("sim/custom/absu/toga_comm")) -- 	режим УХОД


defineProperty("absu_use_second_nav", globalPropertyi("sim/custom/absu_use_second_nav")) -- АБСУ использует второй КурсМП
...
defineProperty("absu_fail_signal", globalPropertyi("sim/custom/absu/absu_fail_signal")) -- сигнал на сирену
