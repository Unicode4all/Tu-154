...
-- controls
defineProperty("absu_zpu_sel", globalPropertyi("sim/custom/switchers/console/absu_zpu_sel")) -- переключатель ЗПУ. лев - прав
defineProperty("absu_nav_on", globalPropertyi("sim/custom/switchers/console/absu_nav_on")) -- стрелки навигация
defineProperty("absu_landing_on", globalPropertyi("sim/custom/switchers/console/absu_landing_on")) -- стрелки посадка
defineProperty("absu_needles_on", globalPropertyi("sim/custom/switchers/console/absu_needles_on")) -- стрелки
defineProperty("absu_speed_mode", globalPropertyi("sim/custom/switchers/console/absu_speed_mode")) -- режим СТУ. 0 - откл, 1 - нву, 2 - аз1, 3 - аз2, 4 - пос
defineProperty("absu_speed_change", globalPropertyi("sim/custom/switchers/console/absu_speed_change")) -- ручка изменения скорости. 
defineProperty("absu_speed_off", globalPropertyi("sim/custom/switchers/console/absu_speed_off")) -- отключение 1 и 2
defineProperty("absu_speed_prepare", globalPropertyi("sim/custom/switchers/console/absu_speed_prepare")) -- подготовка
defineProperty("absu_speed_us_right_left", globalPropertyi("sim/custom/switchers/console/absu_speed_us_right_left")) -- подготовка

defineProperty("absu_roll_ch_on", globalPropertyi("sim/custom/switchers/console/absu_roll_ch_on")) -- выключатель канал крена
defineProperty("absu_pitch_ch_on", globalPropertyi("sim/custom/switchers/console/absu_pitch_ch_on")) -- выключатель канала тангажа
defineProperty("absu_smooth_on", globalPropertyi("sim/custom/switchers/console/absu_smooth_on")) -- выключатель "в болтанку"

defineProperty("absu_turn_handle", globalPropertyi("sim/custom/switchers/console/absu_turn_handle")) -- ручка поворота
defineProperty("absu_pitch_wheel", globalPropertyf("sim/custom/switchers/console/absu_pitch_wheel")) -- колесико спуска, подъема
defineProperty("absu_pitch_wheel_dir", globalPropertyi("sim/custom/switchers/console/absu_pitch_wheel_dir")) -- колесико спуска, подъема
...
defineProperty("hydro_circuit_auto_man", globalPropertyi("sim/custom/switchers/eng/hydro_circuit_auto_man")) -- кольцевание автомат - ручное
defineProperty("hydro_long_control", globalPropertyi("sim/custom/switchers/eng/hydro_long_control")) -- продольная управляемость

defineProperty("hydro_circuit_auto_man_cap", globalPropertyi("sim/custom/switchers/eng/hydro_circuit_auto_man_cap")) -- кольцевание автомат - ручное
defineProperty("hydro_long_control_cap", globalPropertyi("sim/custom/switchers/eng/hydro_long_control_cap")) -- продольная управляемость
...
-- buttons
defineProperty("absu_zk", globalPropertyi("sim/custom/buttons/console/absu_zk")) -- кнопка ЗК на панели АБСУ
defineProperty("absu_reset", globalPropertyi("sim/custom/buttons/console/absu_reset")) -- кнопка сброс программы на панели АБСУ
defineProperty("absu_nvu", globalPropertyi("sim/custom/buttons/console/absu_nvu")) -- кнопка НВУ на панели АБСУ
defineProperty("absu_az1", globalPropertyi("sim/custom/buttons/console/absu_az1")) -- кнопка АЗ 1 на панели АБСУ
defineProperty("absu_az2", globalPropertyi("sim/custom/buttons/console/absu_az2")) -- кнопка АЗ 2 на панели АБСУ
defineProperty("absu_app", globalPropertyi("sim/custom/buttons/console/absu_app")) -- кнопка заход на панели АБСУ
defineProperty("absu_gs", globalPropertyi("sim/custom/buttons/console/absu_gs")) -- кнопка глиссада на панели АБСУ
defineProperty("absu_stab_m", globalPropertyi("sim/custom/buttons/console/absu_stab_m")) -- кнопка M на панели АБСУ
defineProperty("absu_stab_v", globalPropertyi("sim/custom/buttons/console/absu_stab_v")) -- кнопка V на панели АБСУ
defineProperty("absu_stab_h", globalPropertyi("sim/custom/buttons/console/absu_stab_h")) -- кнопка H на панели АБСУ
defineProperty("absu_stab", globalPropertyi("sim/custom/buttons/console/absu_stab")) -- кнопка СТАБ на панели АБСУ

defineProperty("absu_arrest", globalPropertyi("sim/custom/buttons/console/absu_arrest")) -- кнопки арретировки МГВ
defineProperty("absu_speed_test_1", globalPropertyi("sim/custom/buttons/console/absu_speed_test_1")) -- кнопка првоерки СТУ нижняя
defineProperty("absu_speed_test_2", globalPropertyi("sim/custom/buttons/console/absu_speed_test_2")) -- кнопка првоерки СТУ верхняя

defineProperty("absu_stab_speed", globalPropertyi("sim/custom/buttons/console/absu_stab_speed")) -- кнопка C на панели АБСУ
defineProperty("absu_throt_off_1", globalPropertyi("sim/custom/buttons/console/absu_throt_off_1")) -- кнопка откл Г1 на панели АБСУ
defineProperty("absu_throt_off_2", globalPropertyi("sim/custom/buttons/console/absu_throt_off_2")) -- кнопка откл Г2 на панели АБСУ
defineProperty("absu_throt_off_3", globalPropertyi("sim/custom/buttons/console/absu_throt_off_3")) -- кнопка откл Г3 на панели АБСУ


-- caps
defineProperty("absu_arrest_cap", globalPropertyi("sim/custom/buttons/console/absu_arrest_cap")) -- кнопка првоерки СТУ верхняя
defineProperty("absu_smooth_on_cap", globalPropertyi("sim/custom/switchers/console/absu_smooth_on_cap")) -- выключатель "в болтанку"
defineProperty("absu_speed_prepare_cap", globalPropertyi("sim/custom/switchers/console/absu_speed_prepare_cap")) -- подготовка
defineProperty("absu_speed_off_cap", globalPropertyi("sim/custom/switchers/console/absu_speed_off_cap")) -- отключение 1 и 2

-- lamps
defineProperty("absu_zk_lamp", globalPropertyf("sim/custom/lights/button/absu_zk")) -- АБСУ ЗК
defineProperty("absu_reset_lamp", globalPropertyf("sim/custom/lights/button/absu_reset")) -- АБСУ ЗК
defineProperty("absu_nvu_lamp", globalPropertyf("sim/custom/lights/button/absu_nvu")) -- АБСУ ЗК
defineProperty("absu_az1_lamp", globalPropertyf("sim/custom/lights/button/absu_az1")) -- АБСУ ЗК
defineProperty("absu_az2_lamp", globalPropertyf("sim/custom/lights/button/absu_az2")) -- АБСУ ЗК
defineProperty("absu_app_lamp", globalPropertyf("sim/custom/lights/button/absu_app")) -- АБСУ ЗК
defineProperty("absu_gz_lamp", globalPropertyf("sim/custom/lights/button/absu_gz")) -- АБСУ ЗК
defineProperty("absu_stab_m_lamp", globalPropertyf("sim/custom/lights/button/absu_stab_m")) -- АБСУ ЗК
defineProperty("absu_stab_v_lamp", globalPropertyf("sim/custom/lights/button/absu_stab_v")) -- АБСУ ЗК
defineProperty("absu_stab_h_lamp", globalPropertyf("sim/custom/lights/button/absu_stab_h")) -- АБСУ ЗК
defineProperty("absu_stab_lamp", globalPropertyf("sim/custom/lights/button/absu_stab")) -- АБСУ ЗК
defineProperty("absu_stab_spd_lamp", globalPropertyf("sim/custom/lights/button/absu_stab_spd")) -- АБСУ ЗК
defineProperty("absu_thro1_lamp", globalPropertyf("sim/custom/lights/button/absu_thro1")) -- АБСУ ЗК
defineProperty("absu_thro2_lamp", globalPropertyf("sim/custom/lights/button/absu_thro2")) -- АБСУ ЗК
defineProperty("absu_thro3_lamp", globalPropertyf("sim/custom/lights/button/absu_thro3")) -- АБСУ ЗК

defineProperty("stu_roll_lamp", globalPropertyf("sim/custom/lights/small/stu_roll")) -- крен
defineProperty("stu_pitch_lamp", globalPropertyf("sim/custom/lights/small/stu_pitch")) -- тангаж
defineProperty("stu_toga_lamp", globalPropertyf("sim/custom/lights/small/stu_toga")) -- УХОД

defineProperty("at_1_lamp", globalPropertyf("sim/custom/lights/small/at_1")) -- АТ 1
defineProperty("at_2_lamp", globalPropertyf("sim/custom/lights/small/at_2")) -- АТ 2

defineProperty("course_lim", globalPropertyf("sim/custom/lights/course_lim")) -- выход за пределы курса
defineProperty("gs_lim", globalPropertyf("sim/custom/lights/gs_lim")) -- выход за пределы глиссады




-- forward panel lamps
defineProperty("wrong_trimm", globalPropertyf("sim/custom/lights/wrong_trimm")) -- ложное триммирование
defineProperty("controll_roll", globalPropertyf("sim/custom/lights/controll_roll")) -- управляй креном
defineProperty("controll_pitch", globalPropertyf("sim/custom/lights/controll_pitch")) -- управляй тангажом
defineProperty("yoke_sign", globalPropertyf("sim/custom/lights/yoke_sign")) -- сигнализация ухода на второй круг в штурвальном режиме
defineProperty("triangle", globalPropertyf("sim/custom/lights/triangle")) -- интегральный сигнальный огонь
defineProperty("controll_thrust", globalPropertyf("sim/custom/lights/controll_thrust")) -- управляй тягой

defineProperty("toga", globalPropertyf("sim/custom/lights/toga")) -- уход

defineProperty("course", globalPropertyf("sim/custom/lights/course")) -- КУРС
defineProperty("glideslope", globalPropertyf("sim/custom/lights/glideslope")) -- ГЛИСС
defineProperty("zk_lamp", globalPropertyf("sim/custom/lights/zk_lamp")) -- ЗК
defineProperty("thrust_automat", globalPropertyf("sim/custom/lights/thrust_automat")) -- автомат тяги
defineProperty("stab_roll", globalPropertyf("sim/custom/lights/stab_roll")) -- стабилизация боков
defineProperty("stab_pitch", globalPropertyf("sim/custom/lights/stab_pitch")) -- стабилизация продольная
defineProperty("nvu_lamp", globalPropertyf("sim/custom/lights/nvu_lamp")) -- НВУ
defineProperty("vor_lamp", globalPropertyf("sim/custom/lights/vor_lamp")) -- VOR

defineProperty("stab_h", globalPropertyf("sim/custom/lights/stab_h")) -- стаб H
defineProperty("stab_v", globalPropertyf("sim/custom/lights/stab_v")) -- стаб V
defineProperty("stab_m", globalPropertyf("sim/custom/lights/stab_m")) -- стаб M

defineProperty("pitch_control_fail", globalPropertyf("sim/custom/lights/pitch_control_fail")) -- продол управл
defineProperty("roll_control_fail", globalPropertyf("sim/custom/lights/roll_control_fail")) -- боков управл

defineProperty("absu_work", globalPropertyf("sim/custom/lights/absu_work")) -- испр АБСУ

defineProperty("sns_lamp", globalPropertyf("sim/custom/lights/sns_lamp")) -- SNS lamp



-- eng panel lamps
defineProperty("ra56_roll_fail_1", globalPropertyf("sim/custom/lights/ra56_roll_fail_1")) -- отказ РА56 крен
defineProperty("ra56_roll_fail_2", globalPropertyf("sim/custom/lights/ra56_roll_fail_2")) -- отказ РА56 крен
defineProperty("ra56_roll_fail_3", globalPropertyf("sim/custom/lights/ra56_roll_fail_3")) -- отказ РА56 крен

defineProperty("ra56_pitch_fail_1", globalPropertyf("sim/custom/lights/ra56_pitch_fail_1")) -- отказ РА56 тангаж
defineProperty("ra56_pitch_fail_2", globalPropertyf("sim/custom/lights/ra56_pitch_fail_2")) -- отказ РА56 тангаж
defineProperty("ra56_pitch_fail_3", globalPropertyf("sim/custom/lights/ra56_pitch_fail_3")) -- отказ РА56 тангаж

defineProperty("ra56_course_fail_1", globalPropertyf("sim/custom/lights/ra56_course_fail_1")) -- отказ РА56 курс
defineProperty("ra56_course_fail_2", globalPropertyf("sim/custom/lights/ra56_course_fail_2")) -- отказ РА56 курс
defineProperty("ra56_course_fail_3", globalPropertyf("sim/custom/lights/ra56_course_fail_3")) -- отказ РА56 курс

defineProperty("eng_at_on_lamp", globalPropertyf("sim/custom/lights/engines/eng_at_on")) -- АТ включен
...
defineProperty("lamp_test_eng", globalPropertyi("sim/custom/buttons/lamp_test_pa56")) -- кнопка проверки ламп на панели	БИ


-- 

defineProperty("roll_main_mode", globalPropertyi("sim/custom/absu/roll_main_mode")) -- основной режим АБСУ по крену. 0 - выкл, 1 - штурвальный - 2 - стаб
defineProperty("pitch_main_mode", globalPropertyi("sim/custom/absu/pitch_main_mode")) -- основной режим АБСУ по тангажу. 0 - выкл, 1 - штурвальный - 2 - стаб

defineProperty("roll_sub_mode", globalPropertyi("sim/custom/absu/roll_sub_mode")) -- режим АБСУ по крену. 0 - выкл, 1 - стаб, 2 - ЗК, 3 - НВУ, 4 - АЗ1, 5 - АЗ2, 6 - заход
defineProperty("pitch_sub_mode", globalPropertyi("sim/custom/absu/pitch_sub_mode")) -- режим АБСУ по тангажу. 0 - выкл, 1 - стаб, 2 - V, 3 - M, 4 - H, 5 - глисс, 6 - уход

defineProperty("stu_mode", globalPropertyi("sim/custom/absu/stu_mode")) -- режимы автомата тяги 0 - выкл, 1 - вкл, 2 - готов, 3 стаб, 4 - уход	
defineProperty("absu_speed_off", globalPropertyi("sim/custom/switchers/console/absu_speed_off")) -- отключение 1 и 2
...
defineProperty("absu_pnp_mode_1", globalPropertyi("sim/custom/absu/absu_pnp_mode_1")) -- режим индикации ПНП. 0 = off, 1 = НВУ, 2 = VOR1, 3 = VOR2, 4 = ПС
defineProperty("absu_pnp_mode_2", globalPropertyi("sim/custom/absu/absu_pnp_mode_2")) -- режим индикации ПНП. 0 = off, 1 = НВУ, 2 = VOR1, 3 = VOR2, 4 = ПС

defineProperty("absu_course_out", globalPropertyi("sim/custom/absu_course_out")) -- flying outside the course limits
defineProperty("absu_gs_out", globalPropertyi("sim/custom/absu_gs_out")) -- flying outside the course limits
...
defineProperty("sau_stu_on", globalPropertyi("sim/custom/switchers/ovhd/sau_stu_on"))  -- САУ СТУ выключатель

defineProperty("tks_fail_left", globalPropertyi("sim/custom/tks/fail_left")) -- флаг отказа
defineProperty("tks_fail_right", globalPropertyi("sim/custom/tks/fail_right")) -- флаг отказа
...
-- failures
defineProperty("absu_ra56_roll_fail", globalPropertyi("sim/custom/failures/absu_ra56_roll_fail")) -- отказ ra56
defineProperty("absu_ra56_pitch_fail", globalPropertyi("sim/custom/failures/absu_ra56_pitch_fail")) -- отказ ra56
defineProperty("absu_ra56_yaw_fail", globalPropertyi("sim/custom/failures/absu_ra56_yaw_fail")) -- отказ ra56

defineProperty("absu_at1_fail", globalPropertyi("sim/custom/failures/absu_at1_fail")) -- отказ AT
defineProperty("absu_at2_fail", globalPropertyi("sim/custom/failures/absu_at2_fail")) -- отказ AT

defineProperty("absu_damp_roll_fail", globalPropertyi("sim/custom/failures/absu_damp_roll_fail")) -- отказ демперов крена
defineProperty("absu_damp_pitch_fail", globalPropertyi("sim/custom/failures/absu_damp_pitch_fail")) -- отказ демперов тангажа
defineProperty("absu_damp_yaw_fail", globalPropertyi("sim/custom/failures/absu_damp_yaw_fail")) -- отказ демперов курса
defineProperty("absu_contr_roll_fail", globalPropertyi("sim/custom/failures/absu_contr_roll_fail")) -- отказ бокового управления
defineProperty("absu_contr_pitch_fail", globalPropertyi("sim/custom/failures/absu_contr_pitch_fail")) -- отказ продольного управления
defineProperty("absu_calc_toga_fail", globalPropertyi("sim/custom/failures/absu_calc_toga_fail")) -- отказ вычислителя УХОД
defineProperty("absu_calc_roll_fail", globalPropertyi("sim/custom/failures/absu_calc_roll_fail")) -- отказ бокового канала СТУ
defineProperty("absu_calc_pitch_fail", globalPropertyi("sim/custom/failures/absu_calc_pitch_fail")) -- отказ продольного канала СТУ
