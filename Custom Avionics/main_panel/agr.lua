...
-- controls
defineProperty("pitch_corr_hdl", globalPropertyf("sim/custom/gauges/ahz/pitch_corr_C")) -- коррекция тангажа на АГР + вправо
defineProperty("agr_on", globalPropertyi("sim/custom/switchers/ovhd/agr_on")) -- выключатель
...
-- fail
defineProperty("agr_fail", globalPropertyi("sim/custom/failures/agr_fail")) -- отказ


-- results
defineProperty("res_pitch", globalPropertyf("sim/custom/gauges/ahz/pitch_C")) -- тангаж на АГР + нос вверх
defineProperty("res_roll", globalPropertyf("sim/custom/gauges/ahz/roll_C")) -- крен на АГР + в право

defineProperty("agr_cc", globalPropertyf("sim/custom/ahz/agr_cc")) -- ток


defineProperty("ahz_flag", globalPropertyf("sim/custom/gauges/ahz/ahz_flag_C")) -- тангаж на АГР + нос вверх
