...
defineProperty("mrp_mode", globalPropertyi("sim/custom/switchers/ovhd/sp50_nav_mode")) -- 0 - landing, 1 = navigation
...
-- lamps
defineProperty("marker_1", globalPropertyf("sim/custom/lights/marker_1")) -- marker 1
defineProperty("marker_2", globalPropertyf("sim/custom/lights/marker_2")) -- marker 2
defineProperty("marker_3", globalPropertyf("sim/custom/lights/marker_3")) -- marker 3
