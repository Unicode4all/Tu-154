...
-- controls
defineProperty("vhf_left", globalPropertyi("sim/custom/rotary/ovhd/vhf_1_left"))  -- knob
defineProperty("vhf_right", globalPropertyi("sim/custom/rotary/ovhd/vhf_1_right"))  -- knob

defineProperty("vhf_on", globalPropertyi("sim/custom/switchers/ovhd/vhf_1_on"))  -- power switch
