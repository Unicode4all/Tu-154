...
defineProperty("vhf_1_on", globalPropertyi("sim/custom/switchers/ovhd/vhf_1_on"))  -- power switch
defineProperty("vhf_2_on", globalPropertyi("sim/custom/switchers/ovhd/vhf_2_on"))  -- power switch


defineProperty("ark_mode_1", globalPropertyi("sim/custom/switchers/ovhd/ark_1_mode")) -- режим АРК 1 0 - выкл, 1 - комп, 2 - ант, 3 - рам
defineProperty("ark_mode_2", globalPropertyi("sim/custom/switchers/ovhd/ark_2_mode")) -- режим АРК 2 0 - выкл, 1 - комп, 2 - ант, 3 - рам
