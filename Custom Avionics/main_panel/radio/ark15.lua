...
-- controls
defineProperty("ark_mode", globalPropertyi("sim/custom/switchers/ovhd/ark_1_mode")) -- режим АРК 1 0 - выкл, 1 - комп, 2 - ант, 3 - рам
defineProperty("ark_channel", globalPropertyi("sim/custom/switchers/ovhd/ark_1_channel")) -- канал АРК 1
defineProperty("ark_hundr_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_hundr_left")) -- сотни частоты 1 - 17
defineProperty("ark_tens_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_tens_left")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_ones_left", globalPropertyi("sim/custom/switchers/ovhd/ark_1_ones_left")) -- единицы частоты 0 - 9
defineProperty("ark_hundr_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_hundr_right")) -- сотни частоты 1 - 17
defineProperty("ark_tens_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_tens_right")) -- десятки частоты 1 - 10 (0)
defineProperty("ark_ones_right", globalPropertyi("sim/custom/switchers/ovhd/ark_1_ones_right")) -- единицы частоты 0 - 9

defineProperty("ark_ramka", globalPropertyi("sim/custom/buttons/ovhd/ark_1_ramka")) -- кнопка рамки

-- light
defineProperty("ark_left_lit", globalPropertyf("sim/custom/lights/ark1_left_lit")) -- подсветка левой части АРК 1
defineProperty("ark_right_lit", globalPropertyf("sim/custom/lights/ark1_right_lit")) -- подсветка правой части АРК 1
defineProperty("ark_all_lit", globalPropertyf("sim/custom/lights/ark1_all_lit")) -- подсветка АРК 1
...
defineProperty("ark15_cc", globalPropertyf("sim/custom/radio/ark15_L_cc")) -- потребление тока АРК
