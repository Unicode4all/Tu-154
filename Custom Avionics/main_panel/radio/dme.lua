...
-- lamps
defineProperty("dme_mile_lit", globalPropertyf("sim/custom/lights/small/dme_mile_left")) -- mile lamp
defineProperty("dme_km_lit", globalPropertyf("sim/custom/lights/small/dme_km_left")) -- km lamp
