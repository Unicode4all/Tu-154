...
defineProperty("nav_fail", globalPropertyi("sim/custom/failures/nav1_fail")) -- fail
defineProperty("dme_fail", globalPropertyi("sim/custom/failures/dme1_fail")) -- fail
...
-- controls
defineProperty("sd75_on", globalPropertyi("sim/custom/switchers/ovhd/sd75_1_on")) -- switch on
defineProperty("curs_np_on", globalPropertyi("sim/custom/switchers/ovhd/curs_np_on_1")) -- switch on


defineProperty("nav_mode", globalPropertyi("sim/custom/switchers/nav_1_mode")) -- режим НАВ1. Захват - VOR-DME
defineProperty("nav_man_auto", globalPropertyi("sim/custom/switchers/nav_1_man_auto")) -- режим ручной - автомат
defineProperty("nav_mile_km", globalPropertyi("sim/custom/switchers/nav_1_mile_km")) -- режим мили - км
defineProperty("nav_left", globalPropertyi("sim/custom/rotary/ovhd/nav_1_left")) -- левая крутилка
defineProperty("nav_right", globalPropertyi("sim/custom/rotary/ovhd/nav_1_right")) -- правая крутилка
defineProperty("nav_but_1", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_1")) -- кнопка 1
defineProperty("nav_but_2", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_2")) -- кнопка 2
defineProperty("nav_but_3", globalPropertyi("sim/custom/buttons/ovhd/nav_1_but_3")) -- кнопка 3

defineProperty("nav_course", globalPropertyi("sim/custom/rotary/console/nav_1_course")) -- ручка установки курса
...
-- results
defineProperty("vor_dme", globalPropertyf("sim/custom/radio/vor_dme_1")) -- distance
