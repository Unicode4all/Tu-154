...
defineProperty("tcas_mode", globalPropertyi("sim/custom/switchers/tcas/tcas_mode"))  --	режим TCAS. -1 = test, 0 - stby, 1 = alt off, 2 = alt on, 3 = TA, 4 = TARA
defineProperty("tcas_rot_big", globalPropertyi("sim/custom/switchers/tcas/tcas_rot_big"))  -- большая вертелка
defineProperty("tcas_rot_small", globalPropertyi("sim/custom/switchers/tcas/tcas_rot_small"))  -- малая вертелка
...
defineProperty("screen_mode", globalPropertyi("sim/custom/tcas/screen_mode"))  -- режим отображения на экране.  -1 = ошибка, 0 = код ответчика, 1 = above mode, 2 = FL mode, 3 = FLT ID, 4 = PLN BIT, 5 = test, 6 = range set, 11-14 = code set
