...
defineProperty("var_on", globalPropertyi("sim/custom/switchers/ovhd/var_left"))  -- оерхед. вар лев
...
defineProperty("vsi_brt", globalPropertyf("sim/custom/gauges/vsi/vsi_brt_left"))  -- яркость

-- source
defineProperty("vvi", globalPropertyf("sim/cockpit2/gauges/indicators/vvi_fpm_pilot")) -- VVI

defineProperty("vvi_int", globalPropertyf("sim/custom/gauges/vvi_left")) -- VVI
