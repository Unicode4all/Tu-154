...
defineProperty("tcas_range_set", globalPropertyi("sim/custom/tcas/range_set"))  -- дистанция на дисплее. 0 = 3, 1 = 5, 2 = 10, 3 = 15 nm
defineProperty("mode_set", globalPropertyi("sim/custom/tcas/mode_set"))  -- режим TCAS. -1 = test, 0 - stby, 1 = alt off, 2 = alt on, 3 = TA, 4 = TARA	4

defineProperty("level_mode", globalPropertyi("sim/custom/tcas/level_mode"))  -- 1 = above, 0 = normal, -1 = below
defineProperty("fl_mode", globalPropertyi("sim/custom/tcas/fl_mode"))  -- 0 = absolute, 1 = relative
defineProperty("flt_id", globalPropertyi("sim/custom/tcas/flt_id"))  -- 0 = cover, 1 = show / change code


defineProperty("tcas_mode_rot", globalPropertyi("sim/custom/switchers/tcas/tcas_mode"))  -- режим TCAS. -1 = test, 0 - stby, 1 = alt off, 2 = alt on, 3 = TA, 4 = TARA	3

defineProperty("frame_time", globalPropertyf("sim/custom/time/frame_time")) -- flight time

defineProperty("tcas_ident_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_ident_btn"))  -- кнопка IDENT
defineProperty("tcas_fcn_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_fcn_btn"))  -- кнопка FCN
defineProperty("tcas_left_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_left_btn"))  -- кнопка <
defineProperty("tcas_right_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_right_btn"))  -- кнопка >
defineProperty("tcas_ent_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_ent_btn"))  -- кнопка ENT
defineProperty("tcas_atc_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_atc_btn"))  -- кнопка ATC
defineProperty("tcas_alt_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_alt_btn"))  -- кнопка ALT
defineProperty("tcas_rng_dn_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_rng_dn_btn"))  -- кнопка RNG DN
defineProperty("tcas_rng_up_btn", globalPropertyi("sim/custom/buttons/tcas/tcas_rng_up_btn"))  -- кнопка RNG UP

defineProperty("tcas_rot_big", globalPropertyi("sim/custom/switchers/tcas/tcas_rot_big"))  -- большая вертелка
...
defineProperty("screen_mode", globalPropertyi("sim/custom/tcas/screen_mode"))  -- отображения на экране. 0 = код ответчика, -1 = ошибка, 1 = test
...
defineProperty("var_on_1", globalPropertyi("sim/custom/switchers/ovhd/var_left"))  -- оерхед. var
defineProperty("var_on_2", globalPropertyi("sim/custom/switchers/ovhd/var_right"))  -- оерхед. var
...
defineProperty("ra_scale_set", globalPropertyi("sim/custom/tcas/ra_scale_set"))  -- RA mode scale set. 0 = none.
defineProperty("vvi", globalPropertyf("sim/flightmodel/position/vh_ind"))  -- vertical velocity of our acf
defineProperty("traffic_det", globalPropertyi("sim/custom/tcas/traffic_det"))  -- появление желтых или красных меток
