...
-- controll
defineProperty("bkk_on", globalPropertyi("sim/custom/switchers/ovhd/bkk_on")) -- выключатель
defineProperty("bkk_contr", globalPropertyi("sim/custom/switchers/ovhd/bkk_contr")) -- контроль

-- roll for check
defineProperty("roll_a", globalPropertyf("sim/custom/bkk/pkp_roll_left")) -- крен на АГР + в право
defineProperty("roll_b", globalPropertyf("sim/custom/bkk/pkp_roll_right")) -- крен на АГР + в право
defineProperty("roll_c", globalPropertyf("sim/custom/gyro/mgv_contr_roll")) -- крен на АГР + в право

-- pitch for check
defineProperty("pitch_a", globalPropertyf("sim/custom/gyro/ahz_pitch_int_L")) -- тангаж на АГР + вверх
defineProperty("pitch_b", globalPropertyf("sim/custom/gyro/ahz_pitch_int_R")) -- тангаж на АГР + вверх
defineProperty("pitch_c", globalPropertyf("sim/custom/gyro/mgv_contr_pitch")) -- тангаж на АГР + вверх

-- fail
defineProperty("bkk_fail", globalPropertyi("sim/custom/failures/bkk_fail")) -- fail




-- results
defineProperty("left_roll_big", globalPropertyi("sim/custom/bkk/left_roll_big")) -- сигнал с БКК - крен лев велик
defineProperty("right_roll_big", globalPropertyi("sim/custom/bkk/right_roll_big")) -- сигнал с БКК - крен прав велик
defineProperty("mgv_contr_fail", globalPropertyi("sim/custom/bkk/mgv_contr_fail")) -- сигнал с БКК - отказ МГВ контр
defineProperty("no_contr_ag", globalPropertyi("sim/custom/bkk/no_contr_ag")) -- сигнал с БКК - нет контроля АГ
...
-- lamps
defineProperty("roll_left_high", globalPropertyf("sim/custom/lights/roll_left_high")) -- крен лев велик
defineProperty("roll_right_high", globalPropertyf("sim/custom/lights/roll_right_high")) -- крен прав велик
defineProperty("mgv_control_fail", globalPropertyf("sim/custom/lights/mgv_control_fail")) -- отказ МГВ контр
defineProperty("no_ag_controll", globalPropertyf("sim/custom/lights/no_ag_controll")) -- нет котроля АГ

defineProperty("bkk_ok", globalPropertyf("sim/custom/lights/small/bkk_ok")) -- bkk
