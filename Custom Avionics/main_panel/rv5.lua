...
defineProperty("test_btn", globalPropertyf("sim/custom/gauges/alt/radioalt_button_left"))  -- Test button

defineProperty("rv_on", globalPropertyi("sim/custom/switchers/ovhd/rv5_1_on"))  -- switcher

defineProperty("rv_fail", globalPropertyi("sim/custom/failures/rv1_fail"))  -- fail
...
defineProperty("rv_сс", globalPropertyf("sim/custom/elec/rv5_left_cc"))  -- Current consumption
