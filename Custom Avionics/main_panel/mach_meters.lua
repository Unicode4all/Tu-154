...
-- results
defineProperty("mach_ind_left", globalPropertyf("sim/custom/gauges/speed/mach_left")) -- скорость маха КВС
defineProperty("mach_ind_right", globalPropertyf("sim/custom/gauges/speed/mach_right")) -- скорость маха 2П
