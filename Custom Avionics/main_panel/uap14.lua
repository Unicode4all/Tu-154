...
defineProperty("auasp_on", globalPropertyi("sim/custom/switchers/ovhd/auasp_on")) -- АУАСП
defineProperty("auasp_contr", globalPropertyi("sim/custom/switchers/ovhd/auasp_contr")) -- АУАСП контроль

defineProperty("gforce_reset", globalPropertyi("sim/custom/buttons/misc/gforce_reset")) -- кнопка сброса стрелок максимальных перегрузок
...
defineProperty("aoa_sector", globalPropertyf("sim/custom/gauges/misc/aoa_sector")) -- сектор индикатора угла атаки
defineProperty("gforce_ind", globalPropertyf("sim/custom/gauges/misc/gforce_ind")) -- индикатор макс перегрузки
defineProperty("gforce_max", globalPropertyf("sim/custom/gauges/misc/gforce_max")) -- индикатор макс перегрузки
defineProperty("gforce_min", globalPropertyf("sim/custom/gauges/misc/gforce_min")) -- индикатор мин перегрузки

defineProperty("auasp_lamp", globalPropertyf("sim/custom/lights/auasp_lamp")) -- лампа на АУАСП
defineProperty("alpha_high", globalPropertyf("sim/custom/lights/alpha_high")) -- предельный УА
defineProperty("g_force_high", globalPropertyf("sim/custom/lights/g_force_high")) -- передельная перегрузка

defineProperty("alpha_critical", globalPropertyi("sim/custom/auasp/alpha_critical")) -- сигнал от АУАСП по критическом УА
defineProperty("gforce_critical", globalPropertyi("sim/custom/auasp/gforce_critical")) -- сигнал от АУАСП по критическом УА
