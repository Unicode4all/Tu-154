...
-- controlls
defineProperty("test_lamps", globalPropertyi("sim/custom/buttons/lamp_test_doors")) -- кнопка проверки ламп панели двигателей
...
-- lamps
defineProperty("other_hatches", globalPropertyf("sim/custom/lights/other_hatches")) -- лампа для незадействованных люков
defineProperty("left_front_pax_door", globalPropertyf("sim/custom/lights/left_front_pax_door")) -- левая передняя дверь открыта
defineProperty("left_mid_pax_door", globalPropertyf("sim/custom/lights/left_mid_pax_door")) -- левая средняя дверь открыта
defineProperty("right_mid_pax_door", globalPropertyf("sim/custom/lights/right_mid_pax_door")) -- средняя средняя дверь открыта
defineProperty("cargo_front_door", globalPropertyf("sim/custom/lights/cargo_front_door")) -- передний багажный люк
defineProperty("cargo_back_door", globalPropertyf("sim/custom/lights/cargo_back_door")) -- задний багажный люк
defineProperty("turn63_lamp", globalPropertyf("sim/custom/lights/turn63_lamp")) -- разворот 63 
defineProperty("nosewheel_turn_off", globalPropertyf("sim/custom/lights/nosewheel_turn_off")) -- поворот не включен
defineProperty("busters_off", globalPropertyf("sim/custom/lights/busters_off")) -- лампа бустера
