...
defineProperty("absu_at_dif", globalPropertyf("sim/custom/absu_at_dif_left")) -- разность скоростей для индикации на ПКП
...
-- controls
defineProperty("pitch_corr_hdl", globalPropertyf("sim/custom/gauges/ahz/pitch_corr_L")) -- коррекция тангажа на АГР + вправо
defineProperty("pkp_on", globalPropertyi("sim/custom/switchers/ovhd/pkp_left_on")) -- выключатель

defineProperty("pkp_fail", globalPropertyi("sim/custom/bkk/pkp_fail_left")) -- сигнал с БКК - отказ ПКП

defineProperty("arrest_btn", globalPropertyi("sim/custom/buttons/console/absu_arrest")) -- кнопки арретировки
...
defineProperty("power_cc", globalPropertyf("sim/custom/bkk/pkp_left_power_cc")) -- отребление тока ПКП
...
-- results
defineProperty("res_pitch", globalPropertyf("sim/custom/gauges/ahz/pitch_L")) -- тангаж на АГР + нос вверх
defineProperty("pitch_int", globalPropertyf("sim/custom/gyro/ahz_pitch_int_L")) -- тангаж на АГР + вверх

defineProperty("res_roll", globalPropertyf("sim/custom/gauges/ahz/roll_L")) -- крен на АГР + в право
defineProperty("res_roll_bkk", globalPropertyf("sim/custom/bkk/pkp_roll_left")) -- крен на АГР + в право

defineProperty("course_plank", globalPropertyf("sim/custom/gauges/ahz/course_plank_L")) -- курсовая планка АГД КВС + в право
defineProperty("gs_plank", globalPropertyf("sim/custom/gauges/ahz/gs_plank_L")) -- глиссадная планка АГД КВС + вверх


defineProperty("dir_roll", globalPropertyf("sim/custom/gauges/ahz/dir_roll_L")) -- директор крена АГД КВС + в право
defineProperty("dir_pitch", globalPropertyf("sim/custom/gauges/ahz/dir_pitch_L")) -- директор тангажа на АГД КВС + вверх


defineProperty("speed_plank", globalPropertyf("sim/custom/gauges/ahz/speed_plank_L")) -- изменение скорости АГД КВС + вверх

defineProperty("dir_roll_flag", globalPropertyf("sim/custom/gauges/ahz/dir_roll_flag_L")) -- флаг отказа директора крена АГД КВС
defineProperty("dir_pitch_flag", globalPropertyf("sim/custom/gauges/ahz/dir_pitch_flag_L")) -- флаг отказа директора тангажа АГД КВС
