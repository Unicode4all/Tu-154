...
defineProperty("course_ga", globalPropertyf("sim/custom/tks/course_ga_1")) -- курс на ГА
defineProperty("course_bgmk", globalPropertyf("sim/custom/tks/course_bgmk_1")) -- курс на БГМК
...
defineProperty("obs", globalPropertyf("sim/custom/gauges/compas/pkp_obs_set_L"))  -- set the course

defineProperty("obs_side", globalPropertyf("sim/custom/gauges/compas/pkp_obs_set_R"))  -- set the course


defineProperty("frame_time", globalPropertyf("sim/custom/time/frame_time")) -- flight time


defineProperty("gyro_fail", globalPropertyi("sim/custom/tks/fail_left")) -- флаг отказа
...
defineProperty("nav_course_1", globalPropertyi("sim/custom/rotary/console/nav_1_course")) -- ручка установки курса
defineProperty("nav_course_2", globalPropertyi("sim/custom/rotary/console/nav_2_course")) -- ручка установки курса
...
defineProperty("GNS430_flag", globalPropertyi("sim/custom/SC/GNS430_flag")) -- отклонение от курса на ГНС
...
-- controls
defineProperty("pnp_mode", globalPropertyi("sim/custom/switchers/ovhd/curs_pnp_mode_1")) -- режим курс ПНП. 0 - ГМК, 1 - ГПК
defineProperty("pkp_obs_knob", globalPropertyf("sim/custom/gauges/compas/pkp_obs_knob_L")) -- ручка настройки курса

defineProperty("absu_pnp_mode", globalPropertyi("sim/custom/absu/absu_pnp_mode_1")) -- режим индикации ПНП. 0 = off, 1 = НВУ, 2 = VOR1, 3 = VOR2, 4 = ПС
...
defineProperty("tks_on", globalPropertyi("sim/custom/switchers/ovhd/tks_on_1")) -- выключатель ТКС 


-- results
defineProperty("pkp_gyro_course", globalPropertyf("sim/custom/gauges/compas/pkp_gyro_course_L")) -- курс гироскопа ПКП
defineProperty("pkp_obs", globalPropertyf("sim/custom/gauges/compas/pkp_obs_L")) -- курс полета на ПКП
defineProperty("pkp_helper_course", globalPropertyf("sim/custom/gauges/compas/pkp_helper_course_L")) -- устанвока курса желтой стрелкой на ПКП
defineProperty("pkp_slip_angle", globalPropertyf("sim/custom/gauges/compas/pkp_slip_angle_L")) -- угол сноса на ПКП
defineProperty("pkp_course_plank", globalPropertyf("sim/custom/gauges/compas/pkp_course_plank_L")) -- курсовая планка ПКП КВС + отклонение планки вправо
defineProperty("pkp_gs_plank", globalPropertyf("sim/custom/gauges/compas/pkp_gs_plank_L")) -- глиссадная планка ПКП КВС + отклонение планки вверх
defineProperty("pkp_gs_flag", globalPropertyi("sim/custom/gauges/compas/pkp_gs_flag_L")) -- флаг отказа глиссадной планки
defineProperty("pkp_course_flag", globalPropertyi("sim/custom/gauges/compas/pkp_course_flag_L")) -- флаг отказа курсовой планки
defineProperty("pkp_main_flag", globalPropertyi("sim/custom/gauges/compas/pkp_main_flag_L")) -- флаг отказа курса
defineProperty("pkp_obs_flag", globalPropertyi("sim/custom/gauges/compas/pkp_obs_flag_L")) -- флаг отказа счетчика курса
defineProperty("pkp_obs_one", globalPropertyf("sim/custom/gauges/compas/pkp_obs_one_L")) -- счетчик курса. единицы
defineProperty("pkp_obs_ten", globalPropertyf("sim/custom/gauges/compas/pkp_obs_ten_L")) -- счетчик курса. десятки
defineProperty("pkp_obs_hundr", globalPropertyf("sim/custom/gauges/compas/pkp_obs_hundr_L")) -- счетчик курса. сотни
