...
defineProperty("vbe_alt_left", globalPropertyf("sim/custom/gauges/alt/vbe_alt_left"))  -- indicated altitude in meters
defineProperty("vbe_alt_right", globalPropertyf("sim/custom/gauges/alt/vbe_alt_right"))  -- indicated altitude in meters
...
-- controls
defineProperty("taws_english", globalPropertyi("sim/custom/taws/taws_english")) -- язык системы. 0 - русский, 1 - английский	0
defineProperty("mode_set", globalPropertyi("sim/custom/taws/mode_set")) -- режим работы экрана. 0 - выкл, 1 - карта высот, 2 - вид сбоку, 3 - часы, 4 - процесс включения, 5 - тест

defineProperty("egpws_alarm_1", globalPropertyi("sim/custom/switchers/ovhd/egpws_alarm_1")) -- сигнализация СРПБЗ общ
defineProperty("egpws_alarm_2", globalPropertyi("sim/custom/switchers/ovhd/egpws_alarm_2")) -- сигнализация СРПБЗ закрылки
...
defineProperty("taws_eng_phrase", globalPropertyi("sim/custom/sounds/taws_eng_phrase")) -- номер фразы СРПБЗ на английском
defineProperty("taws_rus_phrase", globalPropertyi("sim/custom/sounds/taws_rus_phrase")) -- номер фразы СРПБЗ на русском
...
defineProperty("gs_msg_int", globalPropertyf("sim/custom/taws/gs_msg_int")) -- интервал сигнала ГЛИССАДА
defineProperty("gs_msg_vol", globalPropertyf("sim/custom/taws/gs_msg_vol")) -- громкость сигнала ГЛИССАДА
