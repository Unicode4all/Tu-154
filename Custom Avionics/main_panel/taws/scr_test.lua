...
defineProperty("mode_set", globalPropertyi("sim/custom/taws/mode_set")) -- режим работы экрана. 0 - выкл, 1 - карта высот, 2 - вид сбоку, 3 - часы, 4 - процесс включения
defineProperty("brt_handle", globalPropertyf("sim/custom/rotary/srpbz/brightness")) -- ручка яркости
