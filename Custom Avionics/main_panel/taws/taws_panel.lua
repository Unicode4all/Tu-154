...
-- panel controls
defineProperty("but_view", globalPropertyi("sim/custom/buttons/srpbz/but_view")) -- кнопка ВИД
defineProperty("but_empty", globalPropertyi("sim/custom/buttons/srpbz/but_empty")) -- кнопка -
defineProperty("but_down", globalPropertyi("sim/custom/buttons/srpbz/but_down")) -- кнопка масштаб вниз
defineProperty("but_up", globalPropertyi("sim/custom/buttons/srpbz/but_up")) -- масштаб вверх
defineProperty("brightness", globalPropertyf("sim/custom/rotary/srpbz/brightness")) -- ручка яркости
...
-- lamps
defineProperty("pull_up_lamp", globalPropertyf("sim/custom/lights/pull_up")) -- тяни вверх
defineProperty("check_alt_left_lamp", globalPropertyf("sim/custom/lights/check_alt_left")) -- тяни вверх
defineProperty("check_alt_right_lamp", globalPropertyf("sim/custom/lights/check_alt_right")) -- тяни вверх
defineProperty("warning_terrain_lamp", globalPropertyf("sim/custom/lights/warning_terrain")) -- тяни вверх
defineProperty("gs_low_lamp", globalPropertyf("sim/custom/lights/gs_low")) -- тяни вверх
defineProperty("srpbz_fail_lamp", globalPropertyf("sim/custom/lights/srpbz_fail")) -- тяни вверх
...
defineProperty("test_lamps", globalPropertyi("sim/custom/buttons/lamp_test_front")) -- кнопка проверки ламп панели ВСУ
...
defineProperty("taws_alt_left", globalPropertyi("sim/custom/taws/taws_alt_left")) -- сравни высоту на левом высотомере
defineProperty("taws_alt_right", globalPropertyi("sim/custom/taws/taws_alt_right")) -- сравни высоту на правом высотомере

defineProperty("mode_set", globalPropertyi("sim/custom/taws/mode_set")) -- режим работы экрана. 0 - выкл, 1 - карта высот, 2 - вид сбоку, 3 - часы, 4 - процесс включения, 5 - тест, 6 - игра, 10 - отказ
