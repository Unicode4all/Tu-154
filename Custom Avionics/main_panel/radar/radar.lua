...
-- controls
defineProperty("rls_on", globalPropertyi("sim/custom/switchers/console/rls_on")) -- power switch
defineProperty("rls_mode", globalPropertyi("sim/custom/switchers/console/rls_mode")) -- mode switch
defineProperty("rls_distance", globalPropertyi("sim/custom/switchers/console/rls_distance")) -- distance switch

defineProperty("rls_brt", globalPropertyf("sim/custom/switchers/console/rls_brt")) -- brightness
defineProperty("rls_contr", globalPropertyf("sim/custom/switchers/console/rls_contr")) -- contrast
defineProperty("rls_signs", globalPropertyf("sim/custom/switchers/console/rls_signs")) -- signs

-- lamps
defineProperty("rls_ready", globalPropertyf("sim/custom/lights/small/rls_ready")) -- ready lamp
defineProperty("rls_weather", globalPropertyf("sim/custom/lights/small/rls_weather")) -- weather lamp
