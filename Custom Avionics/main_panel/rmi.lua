...
-- sources
defineProperty("course_bgmk", globalPropertyf("sim/custom/tks/course_bgmk_2")) -- курс на БГМК
...
defineProperty("ark15_L_ON", globalPropertyf("sim/custom/radio/ark15_L_cc")) -- потребление тока АРК
defineProperty("ark15_R_ON", globalPropertyf("sim/custom/radio/ark15_R_cc")) -- потребление тока АРК

defineProperty("nav_L_ON", globalPropertyf("sim/custom/radio/nav1_pow_cc")) -- потребление тока от КурсМП
defineProperty("nav_R_ON", globalPropertyf("sim/custom/radio/nav2_pow_cc")) -- потребление тока от КурсМП

-- power
defineProperty("bus36_volt", globalPropertyf("sim/custom/elec/bus36_volt_right")) -- напряжение сети 36в


-- results
defineProperty("radiocomp_scale", globalPropertyf("sim/custom/gauges/compas/radiocomp_scale_left")) -- шкала курса на радиокомпасе
defineProperty("bearing_1", globalPropertyf("sim/custom/gauges/compas/bearing_1_left")) -- стрелка направления 1 радиокомпаса
defineProperty("bearing_2", globalPropertyf("sim/custom/gauges/compas/bearing_2_left")) -- стрелка направления 2 радиокомпаса
defineProperty("source_1_switch", globalPropertyi("sim/custom/gauges/compas/source_1_switch_left")) -- переключатель стрелки 1 радиокомпаса. 0 - пусто, 1 - АРК1, 2 - АРК2, 3 - VOR1, 4 - VOR2, 5 - РСБН
defineProperty("source_2_switch", globalPropertyi("sim/custom/gauges/compas/source_2_switch_left")) -- переключатель стрелки 2 радиокомпаса
