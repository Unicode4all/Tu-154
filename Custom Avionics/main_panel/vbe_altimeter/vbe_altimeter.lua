...
defineProperty("brt_knob", globalPropertyf("sim/custom/gauges/alt/vbe_brt_left"))  -- brightness knob
defineProperty("press_knob", globalPropertyi("sim/custom/gauges/alt/vbe_press_knob_left"))  -- pressure knob
defineProperty("fl_knob", globalPropertyi("sim/custom/gauges/alt/vbe_fl_knob_left"))  -- flight level knob
defineProperty("vbe_mode", globalPropertyi("sim/custom/gauges/alt/vbe_mode_left"))  -- meters/feet mode

defineProperty("vbe_flightlevel", globalPropertyi("sim/custom/gauges/alt/vbe_flightlevel_left"))  -- эшелон

defineProperty("mode_button", globalPropertyi("sim/custom/gauges/alt/vbe_mode_but_left"))  -- mode button
...
defineProperty("vbe_on", globalPropertyi("sim/custom/switchers/ovhd/vbe_1_on"))  -- power switcher

defineProperty("vbe_std", globalPropertyi("sim/custom/gauges/alt/vbe_std_left"))  -- включение стандартного давления
-- time
