...
defineProperty("test_lamps", globalPropertyi("sim/custom/buttons/lamp_test_engines")) -- кнопка проверки ламп панели двигателей
defineProperty("lamp_test_fwd", globalPropertyi("sim/custom/buttons/lamp_test_front")) -- кнопка проверки ламп на передней панели	0
...
defineProperty("gauges_on_1_cap", globalPropertyi("sim/custom/switchers/eng/gauges_on_1_cap")) -- приборы контроля двигателей
defineProperty("gauges_on_2_cap", globalPropertyi("sim/custom/switchers/eng/gauges_on_2_cap")) -- приборы контроля двигателей
defineProperty("gauges_on_3_cap", globalPropertyi("sim/custom/switchers/eng/gauges_on_3_cap")) -- приборы контроля двигателей

-- lamps
defineProperty("eng1_dangerous_vibro", globalPropertyf("sim/custom/lights/engines/eng1_dangerous_vibro")) -- опасная вибрация
defineProperty("eng1_oil_level", globalPropertyf("sim/custom/lights/engines/eng1_oil_level")) -- уровень масла
defineProperty("eng1_oil_p", globalPropertyf("sim/custom/lights/engines/eng1_oil_p")) -- давление масла
defineProperty("eng1_bypass_valve", globalPropertyf("sim/custom/lights/engines/eng1_bypass_valve")) -- клапаны перепуска
defineProperty("eng1_vna33", globalPropertyf("sim/custom/lights/engines/eng1_vna33")) -- ВНА 33
defineProperty("eng1_reverse_lock", globalPropertyf("sim/custom/lights/engines/eng1_reverse_lock")) -- замок реверса
defineProperty("eng1_high_vibro", globalPropertyf("sim/custom/lights/engines/eng1_high_vibro")) -- вибрация велика
defineProperty("eng1_chips", globalPropertyf("sim/custom/lights/engines/eng1_chips")) -- стружка в масле
defineProperty("eng1_fuel_p", globalPropertyf("sim/custom/lights/engines/eng1_fuel_p")) -- давление топлива
defineProperty("eng1_filter_fail", globalPropertyf("sim/custom/lights/engines/eng1_filter_fail")) -- фильтр засорен
defineProperty("eng1_vna0", globalPropertyf("sim/custom/lights/engines/eng1_vna0")) -- ВНА 0
defineProperty("eng1_reverse_doors", globalPropertyf("sim/custom/lights/engines/eng1_reverse_doors")) -- створки реверса

defineProperty("eng2_dangerous_vibro", globalPropertyf("sim/custom/lights/engines/eng2_dangerous_vibro")) -- опасная вибрация
defineProperty("eng2_oil_level", globalPropertyf("sim/custom/lights/engines/eng2_oil_level")) -- уровень масла
defineProperty("eng2_oil_p", globalPropertyf("sim/custom/lights/engines/eng2_oil_p")) -- давление масла
defineProperty("eng2_bypass_valve", globalPropertyf("sim/custom/lights/engines/eng2_bypass_valve")) -- клапаны перепуска
defineProperty("eng2_vna33", globalPropertyf("sim/custom/lights/engines/eng2_vna33")) -- ВНА 33
defineProperty("eng_at_on", globalPropertyf("sim/custom/lights/engines/eng_at_on")) -- АТ включен
defineProperty("eng2_high_vibro", globalPropertyf("sim/custom/lights/engines/eng2_high_vibro")) -- вибрация велика
defineProperty("eng2_chips", globalPropertyf("sim/custom/lights/engines/eng2_chips")) -- стружка в масле
defineProperty("eng2_fuel_p", globalPropertyf("sim/custom/lights/engines/eng2_fuel_p")) -- давление топлива
defineProperty("eng2_filter_fail", globalPropertyf("sim/custom/lights/engines/eng2_filter_fail")) -- фильтр засорен
defineProperty("eng2_vna0", globalPropertyf("sim/custom/lights/engines/eng2_vna0")) -- ВНА 0
defineProperty("eng_block", globalPropertyf("sim/custom/lights/engines/eng_block")) -- расстоп сектора

defineProperty("eng3_dangerous_vibro", globalPropertyf("sim/custom/lights/engines/eng3_dangerous_vibro")) -- опасная вибрация
defineProperty("eng3_oil_level", globalPropertyf("sim/custom/lights/engines/eng3_oil_level")) -- уровень масла
defineProperty("eng3_oil_p", globalPropertyf("sim/custom/lights/engines/eng3_oil_p")) -- давление масла
defineProperty("eng3_bypass_valve", globalPropertyf("sim/custom/lights/engines/eng3_bypass_valve")) -- клапаны перепуска
defineProperty("eng3_vna33", globalPropertyf("sim/custom/lights/engines/eng3_vna33")) -- ВНА 33
defineProperty("eng3_reverse_lock", globalPropertyf("sim/custom/lights/engines/eng3_reverse_lock")) -- замок реверса
defineProperty("eng3_high_vibro", globalPropertyf("sim/custom/lights/engines/eng3_high_vibro")) -- вибрация велика
defineProperty("eng3_chips", globalPropertyf("sim/custom/lights/engines/eng3_chips")) -- стружка в масле
defineProperty("eng3_fuel_p", globalPropertyf("sim/custom/lights/engines/eng3_fuel_p")) -- давление топлива
defineProperty("eng3_filter_fail", globalPropertyf("sim/custom/lights/engines/eng3_filter_fail")) -- фильтр засорен
defineProperty("eng3_vna0", globalPropertyf("sim/custom/lights/engines/eng3_vna0")) -- ВНА 0
defineProperty("eng3_reverse_doors", globalPropertyf("sim/custom/lights/engines/eng3_reverse_doors")) -- створки реверса


defineProperty("starter_high_rpm_1", globalPropertyf("sim/custom/lights/small/starter_high_rpm_1")) -- опасные обороты стартера
defineProperty("starter_high_rpm_2", globalPropertyf("sim/custom/lights/small/starter_high_rpm_2")) -- опасные обороты стартера
defineProperty("starter_high_rpm_3", globalPropertyf("sim/custom/lights/small/starter_high_rpm_3")) -- опасные обороты стартера
...
defineProperty("fp_eng_fail_1", globalPropertyf("sim/custom/lights/fp_eng_fail_1")) -- двиг. неиспр 1 на передней панели
defineProperty("fp_eng_fail_2", globalPropertyf("sim/custom/lights/fp_eng_fail_2")) -- двиг. неиспр 2 на передней панели
defineProperty("fp_eng_fail_3", globalPropertyf("sim/custom/lights/fp_eng_fail_3")) -- двиг. неиспр 3 на передней панели

defineProperty("fp_reverse_1", globalPropertyf("sim/custom/lights/fp_reverse_1")) -- створки реверса 1 на передней панели
defineProperty("fp_reverse_3", globalPropertyf("sim/custom/lights/fp_reverse_3")) -- створки реверса 3 на передней панели

defineProperty("oil_meter_qty_1", globalPropertyf("sim/custom/lights/small/oil_meter_1")) -- лампа на масломере
defineProperty("oil_meter_qty_2", globalPropertyf("sim/custom/lights/small/oil_meter_2")) -- лампа на масломере
defineProperty("oil_meter_qty_3", globalPropertyf("sim/custom/lights/small/oil_meter_3")) -- лампа на масломере
...
defineProperty("speaker_fuel", globalPropertyi("sim/custom/alarm/speaker_fuel")) -- остаток топлива 2500 в баке 1
