...
-- controls and gauges
defineProperty("starter_press", globalPropertyf("sim/custom/gauges/eng/starter_press")) -- давление в системе запуска
...
defineProperty("reserv_pump_test", globalPropertyi("sim/custom/buttons/eng/reserv_pump_test")) -- проверка резерв топл насоса



-- lamps
defineProperty("apd_work_1", globalPropertyf("sim/custom/lights/small/apd_work_1")) -- АПД работает
defineProperty("apd_work_2", globalPropertyf("sim/custom/lights/small/apd_work_2")) -- АПД работает
defineProperty("apd_work_3", globalPropertyf("sim/custom/lights/small/apd_work_3")) -- АПД работает
...
defineProperty("bus36_volt_right", globalPropertyf("sim/custom/elec/bus36_volt_right")) -- напряжение сети 36в лев
-- time
