...
-- lights
defineProperty("msrp_mlp_main", globalPropertyf("sim/custom/lights/small/msrp_mlp_main")) -- МСРП. МЛП ОСН
defineProperty("msrp_mlp_aux", globalPropertyf("sim/custom/lights/small/msrp_mlp_aux")) -- МСРП. МЛП ДОП
defineProperty("msrp_up2", globalPropertyf("sim/custom/lights/small/msrp_up2")) -- МСРП. УП2
defineProperty("msrp_mars", globalPropertyf("sim/custom/lights/small/msrp_mars")) -- МСРП. МАРС

-- buttons
defineProperty("lamp_test_msrp", globalPropertyf("sim/custom/buttons/lamp_test_msrp")) -- кнопка проверки ламп МСРП

-- controlls
defineProperty("msrp_date_ten", globalPropertyi("sim/custom/switchers/eng/msrp_date_ten")) -- МРСП дата число десятки
defineProperty("msrp_date_one", globalPropertyi("sim/custom/switchers/eng/msrp_date_one")) -- МРСП дата число единицы
defineProperty("msrp_month_ten", globalPropertyi("sim/custom/switchers/eng/msrp_month_ten")) -- МРСП дата месяц десятки
defineProperty("msrp_month_one", globalPropertyi("sim/custom/switchers/eng/msrp_month_one")) -- МРСП дата месяц единицы
defineProperty("msrp_year_ten", globalPropertyi("sim/custom/switchers/eng/msrp_year_ten")) -- кнопка проверки ламп МСРП
defineProperty("msrp_year_one", globalPropertyi("sim/custom/switchers/eng/msrp_year_one")) -- кнопка проверки ламп МСРП
defineProperty("msrp_route_hun", globalPropertyi("sim/custom/switchers/eng/msrp_route_hun")) -- кнопка проверки ламп МСРП
defineProperty("msrp_route_ten", globalPropertyi("sim/custom/switchers/eng/msrp_route_ten")) -- кнопка проверки ламп МСРП
defineProperty("msrp_route_one", globalPropertyi("sim/custom/switchers/eng/msrp_route_one")) -- кнопка проверки ламп МСРП
defineProperty("msrp_mlp_1", globalPropertyi("sim/custom/switchers/eng/msrp_mlp_1")) -- кнопка проверки ламп МСРП
defineProperty("msrp_mlp_2", globalPropertyi("sim/custom/switchers/eng/msrp_mlp_2")) -- кнопка проверки ламп МСРП
defineProperty("msrp_night_day", globalPropertyi("sim/custom/switchers/eng/msrp_night_day")) -- кнопка проверки ламп МСРП
defineProperty("msrp_main_switch", globalPropertyi("sim/custom/switchers/eng/msrp_main_switch")) -- кнопка проверки ламп МСРП
