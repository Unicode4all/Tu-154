...
defineProperty("msrp_recording", globalPropertyi("sim/custom/msrp/msrp_recording")) -- МСРП в режиме записи

defineProperty("msrp_date_ten", globalPropertyf("sim/custom/switchers/eng/msrp_date_ten")) -- МРСП дата число десятки
defineProperty("msrp_date_one", globalPropertyf("sim/custom/switchers/eng/msrp_date_one")) -- МРСП дата число единицы
defineProperty("msrp_month_ten", globalPropertyf("sim/custom/switchers/eng/msrp_month_ten")) -- МРСП дата месяц десятки
defineProperty("msrp_month_one", globalPropertyf("sim/custom/switchers/eng/msrp_month_one")) -- МРСП дата месяц единицы
defineProperty("msrp_year_ten", globalPropertyf("sim/custom/switchers/eng/msrp_year_ten")) -- кнопка проверки ламп МСРП
defineProperty("msrp_year_one", globalPropertyf("sim/custom/switchers/eng/msrp_year_one")) -- кнопка проверки ламп МСРП
defineProperty("msrp_route_hun", globalPropertyf("sim/custom/switchers/eng/msrp_route_hun")) -- кнопка проверки ламп МСРП
defineProperty("msrp_route_ten", globalPropertyf("sim/custom/switchers/eng/msrp_route_ten")) -- кнопка проверки ламп МСРП
defineProperty("msrp_route_one", globalPropertyf("sim/custom/switchers/eng/msrp_route_one")) -- кнопка проверки ламп МСРП
defineProperty("msrp_mlp_1", globalPropertyf("sim/custom/switchers/eng/msrp_mlp_1")) -- кнопка проверки ламп МСРП
defineProperty("msrp_mlp_2", globalPropertyf("sim/custom/switchers/eng/msrp_mlp_2")) -- кнопка проверки ламп МСРП
defineProperty("msrp_night_day", globalPropertyf("sim/custom/switchers/eng/msrp_night_day")) -- кнопка проверки ламп МСРП
defineProperty("msrp_main_switch", globalPropertyf("sim/custom/switchers/eng/msrp_main_switch")) -- главный выключатель
...
defineProperty("mgv_pitch", globalPropertyf("sim/custom/gyro/mgv_contr_pitch")) -- тангаж на АГР + нос вверх
defineProperty("mgv_roll", globalPropertyf("sim/custom/gyro/mgv_contr_roll")) -- крен на АГР + в право
...
defineProperty("aoa_ind", globalPropertyf("sim/custom/gauges/misc/aoa_ind")) -- индикатор угла атаки
defineProperty("gforce_ind", globalPropertyf("sim/custom/gauges/misc/gforce_ind")) -- индикатор макс перегрузки
...
defineProperty("msrp_power", globalPropertyi("sim/custom/msrp/msrp_power"))  -- MSRP power
