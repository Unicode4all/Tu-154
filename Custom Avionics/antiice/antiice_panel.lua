...
defineProperty("soi_work", globalPropertyf("sim/custom/lights/small/soi_work")) -- лампа исправности обогрева
defineProperty("soi_ice_detected", globalPropertyf("sim/custom/lights/small/soi_ice_detected")) -- лампа обнаружения льда

defineProperty("antiice_slats_lamp", globalPropertyf("sim/custom/lights/small/antiice_slats")) -- лампа исправности обогрева
defineProperty("antiice_eng_1_lamp", globalPropertyf("sim/custom/lights/small/antiice_eng_1")) -- лампа исправности обогрева
defineProperty("antiice_eng_2_lamp", globalPropertyf("sim/custom/lights/small/antiice_eng_2")) -- лампа исправности обогрева
defineProperty("antiice_eng_3_lamp", globalPropertyf("sim/custom/lights/small/antiice_eng_3")) -- лампа исправности обогрева
defineProperty("antiice_wings_lamp", globalPropertyf("sim/custom/lights/small/antiice_wings")) -- лампа исправности обогрева




-- gauges
defineProperty("stab_temp", globalPropertyf("sim/custom/gauges/eng/stab_temp")) -- температура стабилизатора
defineProperty("wing_temp", globalPropertyf("sim/custom/gauges/eng/wing_temp")) -- температура крыла
