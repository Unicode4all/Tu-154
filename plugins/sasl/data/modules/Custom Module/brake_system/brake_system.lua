...
function park_brk_max_hnd(phase)
	if 0 == phase then -- toggle
		...
		--if brk == 0 then if sasl.getXPVersion() < 12 then playSample(brake_hnd_off, 0) end else if sasl.getXPVersion() < 12 then playSample(brake_hnd_on, false) end end
...
function update()
	...
	if park_lever_last ~= park_lvr then
		if park_lvr == 1 then if sasl.getXPVersion() < 12 then playSample(brake_hnd_on, false) end
		else if sasl.getXPVersion() < 12 then playSample(brake_hnd_off, false) end end
