...
defineProperty("ZK_select", globalPropertyi("tu154ce/switchers/ZK_select")) -- тумблер "ввод ЗК" на передней панели. 0-лев, 1-прав	0

defineProperty("absu_smooth_on", globalPropertyi("tu154ce/switchers/console/absu_smooth_on")) -- тумблер "вкл в болтанку"
...
defineProperty("pkp_gyro_course_L", globalPropertyf("tu154ce/gauges/compas/pkp_gyro_course_L")) -- курс гироскопа ПКП
defineProperty("pkp_gyro_course_R", globalPropertyf("tu154ce/gauges/compas/pkp_gyro_course_R")) -- курс гироскопа ПКП


defineProperty("pkp_obs_1", globalPropertyf("tu154ce/gauges/compas/pkp_obs_L")) -- курс полета на ПКП
defineProperty("pkp_obs_2", globalPropertyf("tu154ce/gauges/compas/pkp_obs_R")) -- курс полета на ПКП
-- angular speeds
...
defineProperty("nav_cs_1", globalPropertyf("tu154ce/radio/nav1_cs")) -- course plank
defineProperty("nav_cs_2", globalPropertyf("tu154ce/radio/nav2_cs")) -- course plank
defineProperty("nav_gs_1", globalPropertyf("tu154ce/radio/nav1_gs")) -- glideslope
defineProperty("nav_gs_2", globalPropertyf("tu154ce/radio/nav2_gs")) -- glideslope
